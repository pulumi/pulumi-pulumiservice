...
namespace Pulumi.PulumiService.Orgs.Services
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:orgs/services:Service")]
    public partial class Service : global::Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs? args = null, CustomResourceOptions? options = null)
            : base("pulumiservice:orgs/services:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:orgs/services:Service", name, null, MakeResourceOptions(options, id))
        {
        }
