...
namespace Pulumi.PulumiService.Orgs.Members
{
    [PulumiServiceResourceType("pulumiservice:orgs/members:Member")]
    public partial class Member : global::Pulumi.CustomResource
    {
        ...
        public Member(string name, MemberArgs? args = null, CustomResourceOptions? options = null)
            : base("pulumiservice:orgs/members:Member", name, args ?? new MemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Member(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:orgs/members:Member", name, null, MakeResourceOptions(options, id))
        {
        }
