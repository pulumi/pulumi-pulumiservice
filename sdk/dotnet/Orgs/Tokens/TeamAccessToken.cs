...
{
    [PulumiServiceResourceType("pulumiservice:orgs/tokens:TeamAccessToken")]
    public partial class TeamAccessToken : global::Pulumi.CustomResource
    {
        ...
        public TeamAccessToken(string name, TeamAccessTokenArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:orgs/tokens:TeamAccessToken", name, args ?? new TeamAccessTokenArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TeamAccessToken(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:orgs/tokens:TeamAccessToken", name, null, MakeResourceOptions(options, id))
        {
        }
