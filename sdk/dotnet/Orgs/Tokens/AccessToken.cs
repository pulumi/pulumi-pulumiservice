...
namespace Pulumi.PulumiService.Orgs.Tokens
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:orgs/tokens:AccessToken")]
    public partial class AccessToken : global::Pulumi.CustomResource
    {
        ...
        public AccessToken(string name, AccessTokenArgs? args = null, CustomResourceOptions? options = null)
            : base("pulumiservice:orgs/tokens:AccessToken", name, args ?? new AccessTokenArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessToken(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:orgs/tokens:AccessToken", name, null, MakeResourceOptions(options, id))
        {
        }
