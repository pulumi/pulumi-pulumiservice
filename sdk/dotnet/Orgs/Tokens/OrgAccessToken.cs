...
{
    [PulumiServiceResourceType("pulumiservice:orgs/tokens:OrgAccessToken")]
    public partial class OrgAccessToken : global::Pulumi.CustomResource
    {
        ...
        public OrgAccessToken(string name, OrgAccessTokenArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:orgs/tokens:OrgAccessToken", name, args ?? new OrgAccessTokenArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrgAccessToken(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:orgs/tokens:OrgAccessToken", name, null, MakeResourceOptions(options, id))
        {
        }
