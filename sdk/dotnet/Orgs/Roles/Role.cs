...
{
    [PulumiServiceResourceType("pulumiservice:orgs/roles:Role")]
    public partial class Role : global::Pulumi.CustomResource
    {
        ...
        public Role(string name, RoleArgs? args = null, CustomResourceOptions? options = null)
            : base("pulumiservice:orgs/roles:Role", name, args ?? new RoleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Role(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:orgs/roles:Role", name, null, MakeResourceOptions(options, id))
        {
        }
