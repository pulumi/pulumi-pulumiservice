...
namespace Pulumi.PulumiService.Api.Agents
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api/agents:Pool")]
    public partial class Pool : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("agents")]
        public Output<ImmutableArray<Outputs.DeploymentAgentMetadata>> Agents { get; private set; } = null!;
        ...
        public Pool(string name, PoolArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api/agents:Pool", name, args ?? new PoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api/agents:Pool", name, null, MakeResourceOptions(options, id))
        {
        }
