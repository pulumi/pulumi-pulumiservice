...
namespace Pulumi.PulumiService.Api.Agents
{
    ...
    public partial class Task : global::Pulumi.CustomResource
    {
        ...
        public Task(string name, TaskArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api/agents:Task", name, args ?? new TaskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Task(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api/agents:Task", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TaskArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.CLIIntegrationRefArgs>? _cliIntegrations;
        ...
        /// </summary>
        public InputList<Inputs.CLIIntegrationRefArgs> CliIntegrations
        {
            get => _cliIntegrations ?? (_cliIntegrations = new InputList<Inputs.CLIIntegrationRefArgs>());
            set => _cliIntegrations = value;
        }

        [Input("enabledIntegrations")]
        private InputList<Inputs.AgentTaskIntegrationRefArgs>? _enabledIntegrations;
        ...
        /// </summary>
        public InputList<Inputs.AgentTaskIntegrationRefArgs> EnabledIntegrations
        {
            get => _enabledIntegrations ?? (_enabledIntegrations = new InputList<Inputs.AgentTaskIntegrationRefArgs>());
        ...
        /// </summary>
        [Input("message")]
        public Input<Inputs.AgentUserEventMessageArgs>? Message { get; set; }
