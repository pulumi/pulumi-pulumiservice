...
namespace Pulumi.PulumiService.Api
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api:OrgTemplateCollection")]
    public partial class OrgTemplateCollection : global::Pulumi.CustomResource
    {
        ...
        public OrgTemplateCollection(string name, OrgTemplateCollectionArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api:OrgTemplateCollection", name, args ?? new OrgTemplateCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrgTemplateCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api:OrgTemplateCollection", name, null, MakeResourceOptions(options, id))
        {
        }
