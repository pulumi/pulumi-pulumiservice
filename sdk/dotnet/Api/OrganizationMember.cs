...
namespace Pulumi.PulumiService.Api
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api:OrganizationMember")]
    public partial class OrganizationMember : global::Pulumi.CustomResource
    {
        ...
        public OrganizationMember(string name, OrganizationMemberArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api:OrganizationMember", name, args ?? new OrganizationMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api:OrganizationMember", name, null, MakeResourceOptions(options, id))
        {
        }
