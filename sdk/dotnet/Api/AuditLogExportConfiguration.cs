...
namespace Pulumi.PulumiService.Api
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api:AuditLogExportConfiguration")]
    public partial class AuditLogExportConfiguration : global::Pulumi.CustomResource
    {
        ...
        public AuditLogExportConfiguration(string name, AuditLogExportConfigurationArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api:AuditLogExportConfiguration", name, args ?? new AuditLogExportConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AuditLogExportConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api:AuditLogExportConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
