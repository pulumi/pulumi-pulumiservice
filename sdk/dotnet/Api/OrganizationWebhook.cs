...
namespace Pulumi.PulumiService.Api
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api:OrganizationWebhook")]
    public partial class OrganizationWebhook : global::Pulumi.CustomResource
    {
        ...
        public OrganizationWebhook(string name, OrganizationWebhookArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api:OrganizationWebhook", name, args ?? new OrganizationWebhookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationWebhook(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api:OrganizationWebhook", name, null, MakeResourceOptions(options, id))
        {
        }
