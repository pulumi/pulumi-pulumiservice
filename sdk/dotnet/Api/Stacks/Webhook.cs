...
namespace Pulumi.PulumiService.Api.Stacks
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api/stacks:Webhook")]
    public partial class Webhook : global::Pulumi.CustomResource
    {
        ...
        public Webhook(string name, WebhookArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api/stacks:Webhook", name, args ?? new WebhookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Webhook(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api/stacks:Webhook", name, null, MakeResourceOptions(options, id))
        {
        }
