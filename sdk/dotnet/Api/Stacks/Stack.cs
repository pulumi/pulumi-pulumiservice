...
namespace Pulumi.PulumiService.Api.Stacks
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api/stacks:Stack")]
    public partial class Stack : global::Pulumi.CustomResource
    {
        ...
        public Stack(string name, StackArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api/stacks:Stack", name, args ?? new StackArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Stack(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api/stacks:Stack", name, null, MakeResourceOptions(options, id))
        {
        }
