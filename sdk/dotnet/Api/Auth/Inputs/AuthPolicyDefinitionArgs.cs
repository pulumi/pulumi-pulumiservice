...
namespace Pulumi.PulumiService.Api.Auth.Inputs
{
    ...
    public sealed class AuthPolicyDefinitionArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputMap<ImmutableDictionary<string, object>>? _rules;

        /// <summary>
        /// Additional rule conditions as key-value pairs.
        /// </summary>
        public InputMap<ImmutableDictionary<string, object>> Rules
        {
            get => _rules ?? (_rules = new InputMap<ImmutableDictionary<string, object>>());
            set => _rules = value;
        }
