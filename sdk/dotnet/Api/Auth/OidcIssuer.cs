...
namespace Pulumi.PulumiService.Api.Auth
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api/auth:OidcIssuer")]
    public partial class OidcIssuer : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("jwks")]
        public Output<Outputs.JSONWebKeySet?> Jwks { get; private set; } = null!;
        ...
        public OidcIssuer(string name, OidcIssuerArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api/auth:OidcIssuer", name, args ?? new OidcIssuerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OidcIssuer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api/auth:OidcIssuer", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class OidcIssuerArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("jwks")]
        public Input<Inputs.JSONWebKeySetArgs>? Jwks { get; set; }
