...
namespace Pulumi.PulumiService.Api.Auth
{
    /// <summary>
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api/auth:SAML")]
    public partial class SAML : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("organization")]
        public Output<Outputs.Organization> Organization { get; private set; } = null!;
        ...
        public SAML(string name, SAMLArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api/auth:SAML", name, args ?? new SAMLArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SAML(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api/auth:SAML", name, null, MakeResourceOptions(options, id))
        {
        }
