...
namespace Pulumi.PulumiService.Api.Teams
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api/teams:Role")]
    public partial class Role : global::Pulumi.CustomResource
    {
        ...
        public Role(string name, RoleArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api/teams:Role", name, args ?? new RoleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Role(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api/teams:Role", name, null, MakeResourceOptions(options, id))
        {
        }
