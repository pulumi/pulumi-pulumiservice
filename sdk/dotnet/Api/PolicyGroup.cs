...
namespace Pulumi.PulumiService.Api
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api:PolicyGroup")]
    public partial class PolicyGroup : global::Pulumi.CustomResource
    {
        ...
        public PolicyGroup(string name, PolicyGroupArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api:PolicyGroup", name, args ?? new PolicyGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api:PolicyGroup", name, null, MakeResourceOptions(options, id))
        {
        }
