...
namespace Pulumi.PulumiService.Api.Services
{
    ...
    public partial class Item : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("service")]
        public Output<Pulumi.PulumiService.Api.Outputs.Service> Service { get; private set; } = null!;
        ...
        public Item(string name, ItemArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api/services:Item", name, args ?? new ItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Item(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api/services:Item", name, null, MakeResourceOptions(options, id))
        {
        }
