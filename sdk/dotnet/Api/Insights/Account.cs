...
namespace Pulumi.PulumiService.Api.Insights
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api/insights:Account")]
    public partial class Account : global::Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api/insights:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api/insights:Account", name, null, MakeResourceOptions(options, id))
        {
        }
