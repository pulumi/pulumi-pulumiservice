...
namespace Pulumi.PulumiService.Api
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api:Gate")]
    public partial class Gate : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("rule")]
        public Output<Outputs.ChangeGateApprovalRuleOutput> Rule { get; private set; } = null!;
        ...
        public Gate(string name, GateArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api:Gate", name, args ?? new GateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Gate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api:Gate", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GateArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ChangeGateApprovalRuleInputArgs> Rule { get; set; } = null!;
