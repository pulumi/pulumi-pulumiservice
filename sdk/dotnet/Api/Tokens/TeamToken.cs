...
namespace Pulumi.PulumiService.Api.Tokens
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api/tokens:TeamToken")]
    public partial class TeamToken : global::Pulumi.CustomResource
    {
        ...
        public TeamToken(string name, TeamTokenArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api/tokens:TeamToken", name, args ?? new TeamTokenArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TeamToken(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api/tokens:TeamToken", name, null, MakeResourceOptions(options, id))
        {
        }
