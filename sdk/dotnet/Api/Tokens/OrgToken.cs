...
namespace Pulumi.PulumiService.Api.Tokens
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api/tokens:OrgToken")]
    public partial class OrgToken : global::Pulumi.CustomResource
    {
        ...
        public OrgToken(string name, OrgTokenArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api/tokens:OrgToken", name, args ?? new OrgTokenArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrgToken(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api/tokens:OrgToken", name, null, MakeResourceOptions(options, id))
        {
        }
