...
namespace Pulumi.PulumiService.Api.Integrations
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api/integrations:GitLabIntegration")]
    public partial class GitLabIntegration : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("gitLabOrg")]
        public Output<Outputs.GitLabAppOrganization?> GitLabOrg { get; private set; } = null!;
        ...
        public GitLabIntegration(string name, GitLabIntegrationArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api/integrations:GitLabIntegration", name, args ?? new GitLabIntegrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GitLabIntegration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api/integrations:GitLabIntegration", name, null, MakeResourceOptions(options, id))
        {
        }
