...
namespace Pulumi.PulumiService.Api.Integrations
{
    /// <summary>
    /// Updates GitHub Enterprise Server integration settings.
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api/integrations:GitHubEnterpriseIntegration")]
    public partial class GitHubEnterpriseIntegration : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("ghUrls")]
        public Output<Pulumi.PulumiService.Api.Outputs.GitHubAppURLs?> GhUrls { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Pulumi.PulumiService.Api.Outputs.GitHubAppPermissionRequirement>> NeoGitHubAppPermissionRequirements { get; private set; } = null!;
        ...
        public GitHubEnterpriseIntegration(string name, GitHubEnterpriseIntegrationArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api/integrations:GitHubEnterpriseIntegration", name, args ?? new GitHubEnterpriseIntegrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GitHubEnterpriseIntegration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api/integrations:GitHubEnterpriseIntegration", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GitHubEnterpriseIntegration Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new GitHubEnterpriseIntegration(name, id, options);
        }
    }

    public sealed class GitHubEnterpriseIntegrationArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public GitHubEnterpriseIntegrationArgs()
        {
        }
        public static new GitHubEnterpriseIntegrationArgs Empty => new GitHubEnterpriseIntegrationArgs();
    }
}
