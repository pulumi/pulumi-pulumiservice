...
namespace Pulumi.PulumiService.Api.Integrations
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api/integrations:CustomVCSIntegration")]
    public partial class CustomVCSIntegration : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("repositories")]
        public Output<ImmutableArray<Outputs.CustomVCSRepositoryProperties>> Repositories { get; private set; } = null!;
        ...
        public CustomVCSIntegration(string name, CustomVCSIntegrationArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api/integrations:CustomVCSIntegration", name, args ?? new CustomVCSIntegrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomVCSIntegration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api/integrations:CustomVCSIntegration", name, null, MakeResourceOptions(options, id))
        {
        }
