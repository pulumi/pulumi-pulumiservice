...
namespace Pulumi.PulumiService.Api.Integrations
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api/integrations:GitHubIntegration")]
    public partial class GitHubIntegration : global::Pulumi.CustomResource
    {
        ...
        public GitHubIntegration(string name, GitHubIntegrationArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api/integrations:GitHubIntegration", name, args ?? new GitHubIntegrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GitHubIntegration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api/integrations:GitHubIntegration", name, null, MakeResourceOptions(options, id))
        {
        }
