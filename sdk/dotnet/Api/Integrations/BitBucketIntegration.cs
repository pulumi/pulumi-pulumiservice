...
namespace Pulumi.PulumiService.Api.Integrations
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api/integrations:BitBucketIntegration")]
    public partial class BitBucketIntegration : global::Pulumi.CustomResource
    {
        ...
        public BitBucketIntegration(string name, BitBucketIntegrationArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api/integrations:BitBucketIntegration", name, args ?? new BitBucketIntegrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BitBucketIntegration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api/integrations:BitBucketIntegration", name, null, MakeResourceOptions(options, id))
        {
        }
