...
namespace Pulumi.PulumiService.Api.Deployments
{
    /// <summary>
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api/deployments:ScheduledDeployment")]
    public partial class ScheduledDeployment : global::Pulumi.CustomResource
    {
        ...
        public ScheduledDeployment(string name, ScheduledDeploymentArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api/deployments:ScheduledDeployment", name, args ?? new ScheduledDeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScheduledDeployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api/deployments:ScheduledDeployment", name, null, MakeResourceOptions(options, id))
        {
        }
