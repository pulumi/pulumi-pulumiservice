...
namespace Pulumi.PulumiService.Api.Deployments
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api/deployments:Settings")]
    public partial class Settings : global::Pulumi.CustomResource
    {
        ...
        public Settings(string name, SettingsArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api/deployments:Settings", name, args ?? new SettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Settings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api/deployments:Settings", name, null, MakeResourceOptions(options, id))
        {
        }
