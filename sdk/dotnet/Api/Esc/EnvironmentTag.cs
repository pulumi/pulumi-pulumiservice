...
namespace Pulumi.PulumiService.Api.Esc
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api/esc:EnvironmentTag")]
    public partial class EnvironmentTag : global::Pulumi.CustomResource
    {
        ...
        public EnvironmentTag(string name, EnvironmentTagArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api/esc:EnvironmentTag", name, args ?? new EnvironmentTagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnvironmentTag(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api/esc:EnvironmentTag", name, null, MakeResourceOptions(options, id))
        {
        }
