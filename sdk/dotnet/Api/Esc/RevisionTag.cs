...
namespace Pulumi.PulumiService.Api.Esc
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api/esc:RevisionTag")]
    public partial class RevisionTag : global::Pulumi.CustomResource
    {
        ...
        public RevisionTag(string name, RevisionTagArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api/esc:RevisionTag", name, args ?? new RevisionTagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RevisionTag(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api/esc:RevisionTag", name, null, MakeResourceOptions(options, id))
        {
        }
