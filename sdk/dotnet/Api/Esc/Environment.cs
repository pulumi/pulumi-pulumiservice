...
namespace Pulumi.PulumiService.Api.Esc
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api/esc:Environment")]
    public partial class Environment : global::Pulumi.CustomResource
    {
        ...
        public Environment(string name, EnvironmentArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api/esc:Environment", name, args ?? new EnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Environment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api/esc:Environment", name, null, MakeResourceOptions(options, id))
        {
        }
