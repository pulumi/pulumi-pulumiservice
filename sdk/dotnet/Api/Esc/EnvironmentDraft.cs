...
namespace Pulumi.PulumiService.Api.Esc
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api/esc:EnvironmentDraft")]
    public partial class EnvironmentDraft : global::Pulumi.CustomResource
    {
        ...
        public EnvironmentDraft(string name, EnvironmentDraftArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api/esc:EnvironmentDraft", name, args ?? new EnvironmentDraftArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnvironmentDraft(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api/esc:EnvironmentDraft", name, null, MakeResourceOptions(options, id))
        {
        }
