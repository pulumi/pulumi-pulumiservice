...
namespace Pulumi.PulumiService.Api.Esc
{
    /// <summary>
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api/esc:OpenEnvironmentRequest")]
    public partial class OpenEnvironmentRequest : global::Pulumi.CustomResource
    {
        ...
        public OpenEnvironmentRequest(string name, OpenEnvironmentRequestArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api/esc:OpenEnvironmentRequest", name, args ?? new OpenEnvironmentRequestArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenEnvironmentRequest(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api/esc:OpenEnvironmentRequest", name, null, MakeResourceOptions(options, id))
        {
        }
