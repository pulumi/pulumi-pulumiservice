...
namespace Pulumi.PulumiService.Api.Esc
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api/esc:EnvironmentSchedule")]
    public partial class EnvironmentSchedule : global::Pulumi.CustomResource
    {
        ...
        public EnvironmentSchedule(string name, EnvironmentScheduleArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api/esc:EnvironmentSchedule", name, args ?? new EnvironmentScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnvironmentSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api/esc:EnvironmentSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
