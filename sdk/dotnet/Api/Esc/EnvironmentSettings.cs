...
namespace Pulumi.PulumiService.Api.Esc
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:api/esc:EnvironmentSettings")]
    public partial class EnvironmentSettings : global::Pulumi.CustomResource
    {
        ...
        public EnvironmentSettings(string name, EnvironmentSettingsArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:api/esc:EnvironmentSettings", name, args ?? new EnvironmentSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnvironmentSettings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:api/esc:EnvironmentSettings", name, null, MakeResourceOptions(options, id))
        {
        }
