...
namespace Pulumi.PulumiService.V2.EscPreview
{
    /// <summary>
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v2/escPreview:RevisionTag")]
    public partial class RevisionTag : global::Pulumi.CustomResource
    {
        ...
        public RevisionTag(string name, RevisionTagArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/escPreview:RevisionTag", name, args ?? new RevisionTagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RevisionTag(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/escPreview:RevisionTag", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "pulumiservice:v2/preview:RevisionTag" },
                },
            };
