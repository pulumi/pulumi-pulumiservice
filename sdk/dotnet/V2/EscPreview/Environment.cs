...
namespace Pulumi.PulumiService.V2.EscPreview
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v2/escPreview:Environment")]
    public partial class Environment : global::Pulumi.CustomResource
    {
        ...
        public Environment(string name, EnvironmentArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/escPreview:Environment", name, args ?? new EnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Environment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/escPreview:Environment", name, null, MakeResourceOptions(options, id))
        {
        }
