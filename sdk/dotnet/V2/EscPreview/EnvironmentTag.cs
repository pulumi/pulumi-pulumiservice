...
namespace Pulumi.PulumiService.V2.EscPreview
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v2/escPreview:EnvironmentTag")]
    public partial class EnvironmentTag : global::Pulumi.CustomResource
    {
        ...
        public EnvironmentTag(string name, EnvironmentTagArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/escPreview:EnvironmentTag", name, args ?? new EnvironmentTagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnvironmentTag(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/escPreview:EnvironmentTag", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "pulumiservice:v2/preview:EnvironmentTag" },
                },
            };
