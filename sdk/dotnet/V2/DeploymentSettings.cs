...
namespace Pulumi.PulumiService.V2
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v2:DeploymentSettings")]
    public partial class DeploymentSettings : global::Pulumi.CustomResource
    {
        ...
        public DeploymentSettings(string name, DeploymentSettingsArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v2:DeploymentSettings", name, args ?? new DeploymentSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentSettings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v2:DeploymentSettings", name, null, MakeResourceOptions(options, id))
        {
        }
