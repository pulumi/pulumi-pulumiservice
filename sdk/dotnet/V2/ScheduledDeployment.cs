...
namespace Pulumi.PulumiService.V2
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v2:ScheduledDeployment")]
    public partial class ScheduledDeployment : global::Pulumi.CustomResource
    {
        ...
        public ScheduledDeployment(string name, ScheduledDeploymentArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v2:ScheduledDeployment", name, args ?? new ScheduledDeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScheduledDeployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v2:ScheduledDeployment", name, null, MakeResourceOptions(options, id))
        {
        }
