...
namespace Pulumi.PulumiService.V2.Auth
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v2/auth:Policy")]
    public partial class Policy : global::Pulumi.CustomResource
    {
        ...
        public Policy(string name, PolicyArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/auth:Policy", name, args ?? new PolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Policy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/auth:Policy", name, null, MakeResourceOptions(options, id))
        {
        }
