...
namespace Pulumi.PulumiService.V2
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v2:EnvironmentDraft")]
    public partial class EnvironmentDraft : global::Pulumi.CustomResource
    {
        ...
        public EnvironmentDraft(string name, EnvironmentDraftArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v2:EnvironmentDraft", name, args ?? new EnvironmentDraftArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnvironmentDraft(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v2:EnvironmentDraft", name, null, MakeResourceOptions(options, id))
        {
        }
