...
namespace Pulumi.PulumiService.V2
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v2:StackTag")]
    public partial class StackTag : global::Pulumi.CustomResource
    {
        ...
        public StackTag(string name, StackTagArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v2:StackTag", name, args ?? new StackTagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StackTag(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v2:StackTag", name, null, MakeResourceOptions(options, id))
        {
        }
