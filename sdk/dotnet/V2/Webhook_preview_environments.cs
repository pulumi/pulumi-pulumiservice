...
namespace Pulumi.PulumiService.V2
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v2:Webhook_preview_environments")]
    public partial class Webhook_preview_environments : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// <summary>
        /// Create a Webhook_preview_environments resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public Webhook_preview_environments(string name, Webhook_preview_environmentsArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v2:Webhook_preview_environments", name, args ?? new Webhook_preview_environmentsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Webhook_preview_environments(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v2:Webhook_preview_environments", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <summary>
        /// Get an existing Webhook_preview_environments resource's state with the given name, ID, and optional extra
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Webhook_preview_environments Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new Webhook_preview_environments(name, id, options);
        }
    }

    public sealed class Webhook_preview_environmentsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Whether the webhook is active and will receive deliveries.
        /// </summary>
        ...
        public Webhook_preview_environmentsArgs()
        {
        }
        public static new Webhook_preview_environmentsArgs Empty => new Webhook_preview_environmentsArgs();
    }
}
