...
namespace Pulumi.PulumiService.V2
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v2:Webhook_esc_environments")]
    public partial class Webhook_esc_environments : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Webhook_esc_environments(string name, Webhook_esc_environmentsArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v2:Webhook_esc_environments", name, args ?? new Webhook_esc_environmentsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Webhook_esc_environments(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v2:Webhook_esc_environments", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Webhook_esc_environments Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new Webhook_esc_environments(name, id, options);
        }
    }

    public sealed class Webhook_esc_environmentsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Whether the webhook is active and will receive deliveries.
        /// </summary>
        ...
        public Webhook_esc_environmentsArgs()
        {
        }
        public static new Webhook_esc_environmentsArgs Empty => new Webhook_esc_environmentsArgs();
    }
}
