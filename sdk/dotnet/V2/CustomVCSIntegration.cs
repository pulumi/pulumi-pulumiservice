...
namespace Pulumi.PulumiService.V2
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v2:CustomVCSIntegration")]
    public partial class CustomVCSIntegration : global::Pulumi.CustomResource
    {
        ...
        public CustomVCSIntegration(string name, CustomVCSIntegrationArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v2:CustomVCSIntegration", name, args ?? new CustomVCSIntegrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomVCSIntegration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v2:CustomVCSIntegration", name, null, MakeResourceOptions(options, id))
        {
        }
