...
namespace Pulumi.PulumiService.V2
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v2:Stack")]
    public partial class Stack : global::Pulumi.CustomResource
    {
        ...
        public Stack(string name, StackArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v2:Stack", name, args ?? new StackArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Stack(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v2:Stack", name, null, MakeResourceOptions(options, id))
        {
        }
