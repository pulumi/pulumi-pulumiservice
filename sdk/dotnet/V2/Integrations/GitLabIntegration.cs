...
namespace Pulumi.PulumiService.V2.Integrations
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v2/integrations:GitLabIntegration")]
    public partial class GitLabIntegration : global::Pulumi.CustomResource
    {
        ...
        public GitLabIntegration(string name, GitLabIntegrationArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/integrations:GitLabIntegration", name, args ?? new GitLabIntegrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GitLabIntegration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/integrations:GitLabIntegration", name, null, MakeResourceOptions(options, id))
        {
        }
