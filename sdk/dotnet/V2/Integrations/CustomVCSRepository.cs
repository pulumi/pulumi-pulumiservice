...
namespace Pulumi.PulumiService.V2.Integrations
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v2/integrations:CustomVCSRepository")]
    public partial class CustomVCSRepository : global::Pulumi.CustomResource
    {
        ...
        public CustomVCSRepository(string name, CustomVCSRepositoryArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/integrations:CustomVCSRepository", name, args ?? new CustomVCSRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomVCSRepository(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/integrations:CustomVCSRepository", name, null, MakeResourceOptions(options, id))
        {
        }
