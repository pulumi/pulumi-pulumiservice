...
namespace Pulumi.PulumiService.V2.Integrations
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v2/integrations:BitBucketIntegration")]
    public partial class BitBucketIntegration : global::Pulumi.CustomResource
    {
        ...
        public BitBucketIntegration(string name, BitBucketIntegrationArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/integrations:BitBucketIntegration", name, args ?? new BitBucketIntegrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BitBucketIntegration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/integrations:BitBucketIntegration", name, null, MakeResourceOptions(options, id))
        {
        }
