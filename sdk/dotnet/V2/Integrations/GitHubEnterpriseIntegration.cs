...
namespace Pulumi.PulumiService.V2.Integrations
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v2/integrations:GitHubEnterpriseIntegration")]
    public partial class GitHubEnterpriseIntegration : global::Pulumi.CustomResource
    {
        ...
        public GitHubEnterpriseIntegration(string name, GitHubEnterpriseIntegrationArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/integrations:GitHubEnterpriseIntegration", name, args ?? new GitHubEnterpriseIntegrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GitHubEnterpriseIntegration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/integrations:GitHubEnterpriseIntegration", name, null, MakeResourceOptions(options, id))
        {
        }
