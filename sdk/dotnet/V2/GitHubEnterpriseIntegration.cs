...
namespace Pulumi.PulumiService.V2
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v2:GitHubEnterpriseIntegration")]
    public partial class GitHubEnterpriseIntegration : global::Pulumi.CustomResource
    {
        ...
        public GitHubEnterpriseIntegration(string name, GitHubEnterpriseIntegrationArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v2:GitHubEnterpriseIntegration", name, args ?? new GitHubEnterpriseIntegrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GitHubEnterpriseIntegration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v2:GitHubEnterpriseIntegration", name, null, MakeResourceOptions(options, id))
        {
        }
