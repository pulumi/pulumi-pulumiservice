...
namespace Pulumi.PulumiService.V2
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v2:TeamToken")]
    public partial class TeamToken : global::Pulumi.CustomResource
    {
        ...
        public TeamToken(string name, TeamTokenArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v2:TeamToken", name, args ?? new TeamTokenArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TeamToken(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v2:TeamToken", name, null, MakeResourceOptions(options, id))
        {
        }
