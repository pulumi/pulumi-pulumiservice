...
namespace Pulumi.PulumiService.V2
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v2:StackWebhook")]
    public partial class StackWebhook : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public StackWebhook(string name, StackWebhookArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v2:StackWebhook", name, args ?? new StackWebhookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StackWebhook(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v2:StackWebhook", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static StackWebhook Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new StackWebhook(name, id, options);
        }
    }

    public sealed class StackWebhookArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Whether the webhook is active and will receive deliveries.
        /// </summary>
        ...
        public StackWebhookArgs()
        {
        }
        public static new StackWebhookArgs Empty => new StackWebhookArgs();
    }
}
