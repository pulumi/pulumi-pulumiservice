...
namespace Pulumi.PulumiService.V2.Insights
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v2/insights:Account")]
    public partial class Account : global::Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/insights:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/insights:Account", name, null, MakeResourceOptions(options, id))
        {
        }
