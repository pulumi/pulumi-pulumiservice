...
namespace Pulumi.PulumiService.V2.Esc
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v2/esc:Environment")]
    public partial class Environment : global::Pulumi.CustomResource
    {
        ...
        public Environment(string name, EnvironmentArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/esc:Environment", name, args ?? new EnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Environment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/esc:Environment", name, null, MakeResourceOptions(options, id))
        {
        }
