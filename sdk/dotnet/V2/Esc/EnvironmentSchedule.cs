...
namespace Pulumi.PulumiService.V2.Esc
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v2/esc:EnvironmentSchedule")]
    public partial class EnvironmentSchedule : global::Pulumi.CustomResource
    {
        ...
        public EnvironmentSchedule(string name, EnvironmentScheduleArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/esc:EnvironmentSchedule", name, args ?? new EnvironmentScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnvironmentSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/esc:EnvironmentSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
