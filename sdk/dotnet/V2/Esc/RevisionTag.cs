...
namespace Pulumi.PulumiService.V2.Esc
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v2/esc:RevisionTag")]
    public partial class RevisionTag : global::Pulumi.CustomResource
    {
        ...
        public RevisionTag(string name, RevisionTagArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/esc:RevisionTag", name, args ?? new RevisionTagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RevisionTag(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/esc:RevisionTag", name, null, MakeResourceOptions(options, id))
        {
        }
