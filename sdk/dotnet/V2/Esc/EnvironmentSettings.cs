...
namespace Pulumi.PulumiService.V2.Esc
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v2/esc:EnvironmentSettings")]
    public partial class EnvironmentSettings : global::Pulumi.CustomResource
    {
        ...
        public EnvironmentSettings(string name, EnvironmentSettingsArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/esc:EnvironmentSettings", name, args ?? new EnvironmentSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnvironmentSettings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/esc:EnvironmentSettings", name, null, MakeResourceOptions(options, id))
        {
        }
