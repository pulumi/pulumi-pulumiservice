...
namespace Pulumi.PulumiService.V2.Esc
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v2/esc:Webhook")]
    public partial class Webhook : global::Pulumi.CustomResource
    {
        ...
        public Webhook(string name, WebhookArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/esc:Webhook", name, args ?? new WebhookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Webhook(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/esc:Webhook", name, null, MakeResourceOptions(options, id))
        {
        }
