...
namespace Pulumi.PulumiService.V2.Esc
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v2/esc:OpenEnvironmentRequest")]
    public partial class OpenEnvironmentRequest : global::Pulumi.CustomResource
    {
        ...
        public OpenEnvironmentRequest(string name, OpenEnvironmentRequestArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/esc:OpenEnvironmentRequest", name, args ?? new OpenEnvironmentRequestArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenEnvironmentRequest(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/esc:OpenEnvironmentRequest", name, null, MakeResourceOptions(options, id))
        {
        }
