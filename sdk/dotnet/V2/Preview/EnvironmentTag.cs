...
namespace Pulumi.PulumiService.V2.Preview
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v2/preview:EnvironmentTag")]
    public partial class EnvironmentTag : global::Pulumi.CustomResource
    {
        ...
        public EnvironmentTag(string name, EnvironmentTagArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/preview:EnvironmentTag", name, args ?? new EnvironmentTagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnvironmentTag(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v2/preview:EnvironmentTag", name, null, MakeResourceOptions(options, id))
        {
        }
