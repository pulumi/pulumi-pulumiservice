...
namespace Pulumi.PulumiService.V2
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v2:ScheduledScanSettings")]
    public partial class ScheduledScanSettings : global::Pulumi.CustomResource
    {
        ...
        public ScheduledScanSettings(string name, ScheduledScanSettingsArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v2:ScheduledScanSettings", name, args ?? new ScheduledScanSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScheduledScanSettings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v2:ScheduledScanSettings", name, null, MakeResourceOptions(options, id))
        {
        }
