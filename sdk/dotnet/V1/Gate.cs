...
namespace Pulumi.PulumiService.V1
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1:Gate")]
    public partial class Gate : global::Pulumi.CustomResource
    {
        ...
        public Gate(string name, GateArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1:Gate", name, args ?? new GateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Gate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1:Gate", name, null, MakeResourceOptions(options, id))
        {
        }
