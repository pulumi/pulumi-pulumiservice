...
namespace Pulumi.PulumiService.V1.Esc
{
    /// <summary>
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1/esc:OpenEnvironmentRequest")]
    public partial class OpenEnvironmentRequest : global::Pulumi.CustomResource
    {
        ...
        public OpenEnvironmentRequest(string name, OpenEnvironmentRequestArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/esc:OpenEnvironmentRequest", name, args ?? new OpenEnvironmentRequestArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenEnvironmentRequest(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/esc:OpenEnvironmentRequest", name, null, MakeResourceOptions(options, id))
        {
        }
