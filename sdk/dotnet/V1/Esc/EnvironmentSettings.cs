...
namespace Pulumi.PulumiService.V1.Esc
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1/esc:EnvironmentSettings")]
    public partial class EnvironmentSettings : global::Pulumi.CustomResource
    {
        ...
        public EnvironmentSettings(string name, EnvironmentSettingsArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/esc:EnvironmentSettings", name, args ?? new EnvironmentSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnvironmentSettings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/esc:EnvironmentSettings", name, null, MakeResourceOptions(options, id))
        {
        }
