...
namespace Pulumi.PulumiService.V1.Esc
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1/esc:EnvironmentDraft")]
    public partial class EnvironmentDraft : global::Pulumi.CustomResource
    {
        ...
        public EnvironmentDraft(string name, EnvironmentDraftArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/esc:EnvironmentDraft", name, args ?? new EnvironmentDraftArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnvironmentDraft(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/esc:EnvironmentDraft", name, null, MakeResourceOptions(options, id))
        {
        }
