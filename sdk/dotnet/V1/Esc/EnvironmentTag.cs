...
namespace Pulumi.PulumiService.V1.Esc
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1/esc:EnvironmentTag")]
    public partial class EnvironmentTag : global::Pulumi.CustomResource
    {
        ...
        public EnvironmentTag(string name, EnvironmentTagArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/esc:EnvironmentTag", name, args ?? new EnvironmentTagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnvironmentTag(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/esc:EnvironmentTag", name, null, MakeResourceOptions(options, id))
        {
        }
