...
namespace Pulumi.PulumiService.V1.Auth
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1/auth:OidcIssuer")]
    public partial class OidcIssuer : global::Pulumi.CustomResource
    {
        ...
        public OidcIssuer(string name, OidcIssuerArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/auth:OidcIssuer", name, args ?? new OidcIssuerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OidcIssuer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/auth:OidcIssuer", name, null, MakeResourceOptions(options, id))
        {
        }
