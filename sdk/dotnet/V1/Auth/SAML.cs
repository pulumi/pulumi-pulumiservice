...
namespace Pulumi.PulumiService.V1.Auth
{
    /// <summary>
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1/auth:SAML")]
    public partial class SAML : global::Pulumi.CustomResource
    {
        ...
        public SAML(string name, SAMLArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/auth:SAML", name, args ?? new SAMLArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SAML(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/auth:SAML", name, null, MakeResourceOptions(options, id))
        {
        }
