...
namespace Pulumi.PulumiService.V1.Auth
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1/auth:Policy")]
    public partial class Policy : global::Pulumi.CustomResource
    {
        ...
        public Policy(string name, PolicyArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/auth:Policy", name, args ?? new PolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Policy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/auth:Policy", name, null, MakeResourceOptions(options, id))
        {
        }
