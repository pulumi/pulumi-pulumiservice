...
namespace Pulumi.PulumiService.V1.Services
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1/services:Item")]
    public partial class Item : global::Pulumi.CustomResource
    {
        ...
        public Item(string name, ItemArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/services:Item", name, args ?? new ItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Item(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/services:Item", name, null, MakeResourceOptions(options, id))
        {
        }
