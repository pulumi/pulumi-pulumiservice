...
namespace Pulumi.PulumiService.V1.Services
{
    /// <summary>
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1/services:Service")]
    public partial class Service : global::Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/services:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/services:Service", name, null, MakeResourceOptions(options, id))
        {
        }
