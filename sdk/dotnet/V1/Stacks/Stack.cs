...
namespace Pulumi.PulumiService.V1.Stacks
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1/stacks:Stack")]
    public partial class Stack : global::Pulumi.CustomResource
    {
        ...
        public Stack(string name, StackArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/stacks:Stack", name, args ?? new StackArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Stack(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/stacks:Stack", name, null, MakeResourceOptions(options, id))
        {
        }
