...
namespace Pulumi.PulumiService.V1.Stacks
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1/stacks:Tag")]
    public partial class Tag : global::Pulumi.CustomResource
    {
        ...
        public Tag(string name, TagArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/stacks:Tag", name, args ?? new TagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Tag(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/stacks:Tag", name, null, MakeResourceOptions(options, id))
        {
        }
