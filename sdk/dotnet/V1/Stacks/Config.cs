...
namespace Pulumi.PulumiService.V1.Stacks
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1/stacks:Config")]
    public partial class Config : global::Pulumi.CustomResource
    {
        ...
        public Config(string name, ConfigArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/stacks:Config", name, args ?? new ConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Config(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/stacks:Config", name, null, MakeResourceOptions(options, id))
        {
        }
