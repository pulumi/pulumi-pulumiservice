...
namespace Pulumi.PulumiService.V1
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1:OrgTemplateCollection")]
    public partial class OrgTemplateCollection : global::Pulumi.CustomResource
    {
        ...
        public OrgTemplateCollection(string name, OrgTemplateCollectionArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1:OrgTemplateCollection", name, args ?? new OrgTemplateCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrgTemplateCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1:OrgTemplateCollection", name, null, MakeResourceOptions(options, id))
        {
        }
