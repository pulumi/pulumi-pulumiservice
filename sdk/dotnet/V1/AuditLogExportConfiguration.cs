...
namespace Pulumi.PulumiService.V1
{
    /// <summary>
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1:AuditLogExportConfiguration")]
    public partial class AuditLogExportConfiguration : global::Pulumi.CustomResource
    {
        ...
        public AuditLogExportConfiguration(string name, AuditLogExportConfigurationArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1:AuditLogExportConfiguration", name, args ?? new AuditLogExportConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AuditLogExportConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1:AuditLogExportConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
