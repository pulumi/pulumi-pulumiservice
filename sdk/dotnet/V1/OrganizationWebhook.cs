...
namespace Pulumi.PulumiService.V1
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1:OrganizationWebhook")]
    public partial class OrganizationWebhook : global::Pulumi.CustomResource
    {
        ...
        public OrganizationWebhook(string name, OrganizationWebhookArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1:OrganizationWebhook", name, args ?? new OrganizationWebhookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationWebhook(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1:OrganizationWebhook", name, null, MakeResourceOptions(options, id))
        {
        }
