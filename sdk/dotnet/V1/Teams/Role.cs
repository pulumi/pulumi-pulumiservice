...
namespace Pulumi.PulumiService.V1.Teams
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1/teams:Role")]
    public partial class Role : global::Pulumi.CustomResource
    {
        ...
        public Role(string name, RoleArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/teams:Role", name, args ?? new RoleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Role(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/teams:Role", name, null, MakeResourceOptions(options, id))
        {
        }
