...
namespace Pulumi.PulumiService.V1.Teams
{
    /// <summary>
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1/teams:Team")]
    public partial class Team : global::Pulumi.CustomResource
    {
        ...
        public Team(string name, TeamArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/teams:Team", name, args ?? new TeamArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Team(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/teams:Team", name, null, MakeResourceOptions(options, id))
        {
        }
