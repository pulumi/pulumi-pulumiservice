...
namespace Pulumi.PulumiService.V1.Tokens
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1/tokens:TeamToken")]
    public partial class TeamToken : global::Pulumi.CustomResource
    {
        ...
        public TeamToken(string name, TeamTokenArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/tokens:TeamToken", name, args ?? new TeamTokenArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TeamToken(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/tokens:TeamToken", name, null, MakeResourceOptions(options, id))
        {
        }
