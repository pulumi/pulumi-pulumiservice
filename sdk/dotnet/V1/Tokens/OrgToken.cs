...
namespace Pulumi.PulumiService.V1.Tokens
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1/tokens:OrgToken")]
    public partial class OrgToken : global::Pulumi.CustomResource
    {
        ...
        public OrgToken(string name, OrgTokenArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/tokens:OrgToken", name, args ?? new OrgTokenArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrgToken(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/tokens:OrgToken", name, null, MakeResourceOptions(options, id))
        {
        }
