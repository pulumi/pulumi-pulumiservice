...
namespace Pulumi.PulumiService.V1.Integrations
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1/integrations:GitHubIntegration")]
    public partial class GitHubIntegration : global::Pulumi.CustomResource
    {
        ...
        public GitHubIntegration(string name, GitHubIntegrationArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/integrations:GitHubIntegration", name, args ?? new GitHubIntegrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GitHubIntegration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/integrations:GitHubIntegration", name, null, MakeResourceOptions(options, id))
        {
        }
