...
namespace Pulumi.PulumiService.V1.Integrations
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1/integrations:AzureDevOpsIntegration")]
    public partial class AzureDevOpsIntegration : global::Pulumi.CustomResource
    {
        ...
        public AzureDevOpsIntegration(string name, AzureDevOpsIntegrationArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/integrations:AzureDevOpsIntegration", name, args ?? new AzureDevOpsIntegrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureDevOpsIntegration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/integrations:AzureDevOpsIntegration", name, null, MakeResourceOptions(options, id))
        {
        }
