...
namespace Pulumi.PulumiService.V1.Integrations
{
    /// <summary>
    /// Updates GitHub Enterprise Server integration settings.
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1/integrations:GitHubEnterpriseIntegration")]
    public partial class GitHubEnterpriseIntegration : global::Pulumi.CustomResource
    {
        ...
        public GitHubEnterpriseIntegration(string name, GitHubEnterpriseIntegrationArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/integrations:GitHubEnterpriseIntegration", name, args ?? new GitHubEnterpriseIntegrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GitHubEnterpriseIntegration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/integrations:GitHubEnterpriseIntegration", name, null, MakeResourceOptions(options, id))
        {
        }
