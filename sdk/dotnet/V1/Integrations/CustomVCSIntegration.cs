...
namespace Pulumi.PulumiService.V1.Integrations
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1/integrations:CustomVCSIntegration")]
    public partial class CustomVCSIntegration : global::Pulumi.CustomResource
    {
        ...
        public CustomVCSIntegration(string name, CustomVCSIntegrationArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/integrations:CustomVCSIntegration", name, args ?? new CustomVCSIntegrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomVCSIntegration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/integrations:CustomVCSIntegration", name, null, MakeResourceOptions(options, id))
        {
        }
