...
namespace Pulumi.PulumiService.V1.Agents
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1/agents:Pool")]
    public partial class Pool : global::Pulumi.CustomResource
    {
        ...
        public Pool(string name, PoolArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/agents:Pool", name, args ?? new PoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/agents:Pool", name, null, MakeResourceOptions(options, id))
        {
        }
