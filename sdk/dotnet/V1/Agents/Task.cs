...
namespace Pulumi.PulumiService.V1.Agents
{
    /// <summary>
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1/agents:Task")]
    public partial class Task : global::Pulumi.CustomResource
    {
        ...
        public Task(string name, TaskArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/agents:Task", name, args ?? new TaskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Task(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/agents:Task", name, null, MakeResourceOptions(options, id))
        {
        }
