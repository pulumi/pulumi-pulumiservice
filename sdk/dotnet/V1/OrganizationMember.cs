...
namespace Pulumi.PulumiService.V1
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1:OrganizationMember")]
    public partial class OrganizationMember : global::Pulumi.CustomResource
    {
        ...
        public OrganizationMember(string name, OrganizationMemberArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1:OrganizationMember", name, args ?? new OrganizationMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1:OrganizationMember", name, null, MakeResourceOptions(options, id))
        {
        }
