...
namespace Pulumi.PulumiService.V1
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1:PolicyGroup")]
    public partial class PolicyGroup : global::Pulumi.CustomResource
    {
        ...
        public PolicyGroup(string name, PolicyGroupArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1:PolicyGroup", name, args ?? new PolicyGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1:PolicyGroup", name, null, MakeResourceOptions(options, id))
        {
        }
