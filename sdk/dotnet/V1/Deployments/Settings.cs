...
namespace Pulumi.PulumiService.V1.Deployments
{
    ...
    /// </summary>
    [PulumiServiceResourceType("pulumiservice:v1/deployments:Settings")]
    public partial class Settings : global::Pulumi.CustomResource
    {
        ...
        public Settings(string name, SettingsArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/deployments:Settings", name, args ?? new SettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Settings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:v1/deployments:Settings", name, null, MakeResourceOptions(options, id))
        {
        }
