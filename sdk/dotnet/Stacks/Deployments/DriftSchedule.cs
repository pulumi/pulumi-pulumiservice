...
{
    [PulumiServiceResourceType("pulumiservice:stacks/deployments:DriftSchedule")]
    public partial class DriftSchedule : global::Pulumi.CustomResource
    {
        ...
        public DriftSchedule(string name, DriftScheduleArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:stacks/deployments:DriftSchedule", name, args ?? new DriftScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DriftSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:stacks/deployments:DriftSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
