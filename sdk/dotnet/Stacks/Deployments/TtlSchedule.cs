...
{
    [PulumiServiceResourceType("pulumiservice:stacks/deployments:TtlSchedule")]
    public partial class TtlSchedule : global::Pulumi.CustomResource
    {
        ...
        public TtlSchedule(string name, TtlScheduleArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:stacks/deployments:TtlSchedule", name, args ?? new TtlScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TtlSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:stacks/deployments:TtlSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
