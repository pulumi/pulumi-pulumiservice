...
{
    [PulumiServiceResourceType("pulumiservice:stacks/tags:Tag")]
    public partial class Tag : global::Pulumi.CustomResource
    {
        ...
        public Tag(string name, TagArgs args, CustomResourceOptions? options = null)
            : base("pulumiservice:stacks/tags:Tag", name, args ?? new TagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Tag(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pulumiservice:stacks/tags:Tag", name, null, MakeResourceOptions(options, id))
        {
        }
