...
func NewStackTag(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("pulumiservice:infer:StackTag", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStackTag(ctx *pulumi.Context,
	...
	var resource StackTag
	err := ctx.ReadResource("pulumiservice:infer:StackTag", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
