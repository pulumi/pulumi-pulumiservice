...
func NewPolicyGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("pulumiservice:v1:PolicyGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicyGroup(ctx *pulumi.Context,
	...
	var resource PolicyGroup
	err := ctx.ReadResource("pulumiservice:v1:PolicyGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
