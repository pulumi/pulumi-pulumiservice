...
func NewService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("pulumiservice:v1/services:Service", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetService(ctx *pulumi.Context,
	...
	var resource Service
	err := ctx.ReadResource("pulumiservice:v1/services:Service", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
