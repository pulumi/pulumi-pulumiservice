...
func NewItem(ctx *pulumi.Context,
	...
	var resource Item
	err := ctx.RegisterResource("pulumiservice:v1/services:Item", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetItem(ctx *pulumi.Context,
	...
	var resource Item
	err := ctx.ReadResource("pulumiservice:v1/services:Item", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
