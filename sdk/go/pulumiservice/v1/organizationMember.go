...
func NewOrganizationMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("pulumiservice:v1:OrganizationMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationMember(ctx *pulumi.Context,
	...
	var resource OrganizationMember
	err := ctx.ReadResource("pulumiservice:v1:OrganizationMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
