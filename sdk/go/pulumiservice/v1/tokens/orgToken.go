...
func NewOrgToken(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("pulumiservice:v1/tokens:OrgToken", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrgToken(ctx *pulumi.Context,
	...
	var resource OrgToken
	err := ctx.ReadResource("pulumiservice:v1/tokens:OrgToken", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
