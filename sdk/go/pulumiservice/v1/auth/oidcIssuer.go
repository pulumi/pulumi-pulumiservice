...
func NewOidcIssuer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("pulumiservice:v1/auth:OidcIssuer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOidcIssuer(ctx *pulumi.Context,
	...
	var resource OidcIssuer
	err := ctx.ReadResource("pulumiservice:v1/auth:OidcIssuer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
