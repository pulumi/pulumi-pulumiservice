...
func NewSAML(ctx *pulumi.Context,
	...
	var resource SAML
	err := ctx.RegisterResource("pulumiservice:v1/auth:SAML", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSAML(ctx *pulumi.Context,
	...
	var resource SAML
	err := ctx.ReadResource("pulumiservice:v1/auth:SAML", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
