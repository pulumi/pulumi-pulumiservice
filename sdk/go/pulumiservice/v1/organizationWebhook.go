...
func NewOrganizationWebhook(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("pulumiservice:v1:OrganizationWebhook", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationWebhook(ctx *pulumi.Context,
	...
	var resource OrganizationWebhook
	err := ctx.ReadResource("pulumiservice:v1:OrganizationWebhook", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
