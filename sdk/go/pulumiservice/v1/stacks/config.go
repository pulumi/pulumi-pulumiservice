...
func NewConfig(ctx *pulumi.Context,
	...
	var resource Config
	err := ctx.RegisterResource("pulumiservice:v1/stacks:Config", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfig(ctx *pulumi.Context,
	...
	var resource Config
	err := ctx.ReadResource("pulumiservice:v1/stacks:Config", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
