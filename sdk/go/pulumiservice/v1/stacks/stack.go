...
func NewStack(ctx *pulumi.Context,
	...
	var resource Stack
	err := ctx.RegisterResource("pulumiservice:v1/stacks:Stack", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStack(ctx *pulumi.Context,
	...
	var resource Stack
	err := ctx.ReadResource("pulumiservice:v1/stacks:Stack", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
