...
func NewEnvironmentTag(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("pulumiservice:v1/esc:EnvironmentTag", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEnvironmentTag(ctx *pulumi.Context,
	...
	var resource EnvironmentTag
	err := ctx.ReadResource("pulumiservice:v1/esc:EnvironmentTag", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
