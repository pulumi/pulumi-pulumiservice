...
func NewPool(ctx *pulumi.Context,
	...
	var resource Pool
	err := ctx.RegisterResource("pulumiservice:v1/agents:Pool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPool(ctx *pulumi.Context,
	...
	var resource Pool
	err := ctx.ReadResource("pulumiservice:v1/agents:Pool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
