...
func NewTask(ctx *pulumi.Context,
	...
	var resource Task
	err := ctx.RegisterResource("pulumiservice:v1/agents:Task", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTask(ctx *pulumi.Context,
	...
	var resource Task
	err := ctx.ReadResource("pulumiservice:v1/agents:Task", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
