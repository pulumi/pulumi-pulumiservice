...
func NewSettings(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("pulumiservice:v1/deployments:Settings", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSettings(ctx *pulumi.Context,
	...
	var resource Settings
	err := ctx.ReadResource("pulumiservice:v1/deployments:Settings", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
