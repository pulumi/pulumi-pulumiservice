...
func NewAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("pulumiservice:v1/insights:Account", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccount(ctx *pulumi.Context,
	...
	var resource Account
	err := ctx.ReadResource("pulumiservice:v1/insights:Account", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
