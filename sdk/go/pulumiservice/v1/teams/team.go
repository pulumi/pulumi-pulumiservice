...
func NewTeam(ctx *pulumi.Context,
	...
	var resource Team
	err := ctx.RegisterResource("pulumiservice:v1/teams:Team", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTeam(ctx *pulumi.Context,
	...
	var resource Team
	err := ctx.ReadResource("pulumiservice:v1/teams:Team", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
