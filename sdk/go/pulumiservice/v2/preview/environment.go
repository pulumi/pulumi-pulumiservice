...
func NewEnvironment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("pulumiservice:v2/preview:Environment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEnvironment(ctx *pulumi.Context,
	...
	var resource Environment
	err := ctx.ReadResource("pulumiservice:v2/preview:Environment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
