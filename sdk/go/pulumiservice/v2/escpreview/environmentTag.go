...
func NewEnvironmentTag(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("pulumiservice:v2/preview:EnvironmentTag"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource EnvironmentTag
	err := ctx.RegisterResource("pulumiservice:v2/escPreview:EnvironmentTag", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEnvironmentTag(ctx *pulumi.Context,
	...
	var resource EnvironmentTag
	err := ctx.ReadResource("pulumiservice:v2/escPreview:EnvironmentTag", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
