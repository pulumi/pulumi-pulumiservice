...
func NewWebhook(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("pulumiservice:v2/preview:Webhook"),
		},
	})
	...
	err := ctx.RegisterResource("pulumiservice:v2/escPreview:Webhook", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebhook(ctx *pulumi.Context,
	...
	var resource Webhook
	err := ctx.ReadResource("pulumiservice:v2/escPreview:Webhook", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
