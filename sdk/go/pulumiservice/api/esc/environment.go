...
func NewEnvironment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("pulumiservice:api/esc:Environment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEnvironment(ctx *pulumi.Context,
	...
	var resource Environment
	err := ctx.ReadResource("pulumiservice:api/esc:Environment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
