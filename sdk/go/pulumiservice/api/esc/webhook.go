...
func NewWebhook(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("pulumiservice:api/esc:Webhook", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebhook(ctx *pulumi.Context,
	...
	var resource Webhook
	err := ctx.ReadResource("pulumiservice:api/esc:Webhook", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
