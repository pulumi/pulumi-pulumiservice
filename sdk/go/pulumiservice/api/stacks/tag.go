...
func NewTag(ctx *pulumi.Context,
	...
	var resource Tag
	err := ctx.RegisterResource("pulumiservice:api/stacks:Tag", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTag(ctx *pulumi.Context,
	...
	var resource Tag
	err := ctx.ReadResource("pulumiservice:api/stacks:Tag", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
