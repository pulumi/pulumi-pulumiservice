...
type Gate struct {
	...
	Rule ChangeGateApprovalRuleOutputOutput `pulumi:"rule"`
...
func NewGate(ctx *pulumi.Context,
	...
	var resource Gate
	err := ctx.RegisterResource("pulumiservice:api:Gate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGate(ctx *pulumi.Context,
	...
	var resource Gate
	err := ctx.ReadResource("pulumiservice:api:Gate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type gateArgs struct {
	...
	// Rule configuration for the gate
	Rule ChangeGateApprovalRuleInput `pulumi:"rule"`
	// Target configuration for the gate
...
type GateArgs struct {
	...
	// Rule configuration for the gate
	Rule ChangeGateApprovalRuleInputInput
	// Target configuration for the gate
...
// Rule configuration for the gate
func (o GateOutput) Rule() ChangeGateApprovalRuleOutputOutput {
	return o.ApplyT(func(v *Gate) ChangeGateApprovalRuleOutputOutput { return v.Rule }).(ChangeGateApprovalRuleOutputOutput)
}
