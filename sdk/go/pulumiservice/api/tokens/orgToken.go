...
func NewOrgToken(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("pulumiservice:api/tokens:OrgToken", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrgToken(ctx *pulumi.Context,
	...
	var resource OrgToken
	err := ctx.ReadResource("pulumiservice:api/tokens:OrgToken", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
