...
type OidcIssuer struct {
	...
	Jwks api.JSONWebKeySetPtrOutput `pulumi:"jwks"`
...
func NewOidcIssuer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("pulumiservice:api/auth:OidcIssuer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOidcIssuer(ctx *pulumi.Context,
	...
	var resource OidcIssuer
	err := ctx.ReadResource("pulumiservice:api/auth:OidcIssuer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type oidcIssuerArgs struct {
	...
	// The JSON Web Key Set for the OIDC issuer.
	Jwks *api.JSONWebKeySet `pulumi:"jwks"`
	// The maximum token expiration time in seconds.
...
type OidcIssuerArgs struct {
	...
	// The JSON Web Key Set for the OIDC issuer.
	Jwks api.JSONWebKeySetPtrInput
	// The maximum token expiration time in seconds.
...
// The JSON Web Key Set for the OIDC issuer.
func (o OidcIssuerOutput) Jwks() api.JSONWebKeySetPtrOutput {
	return o.ApplyT(func(v *OidcIssuer) api.JSONWebKeySetPtrOutput { return v.Jwks }).(api.JSONWebKeySetPtrOutput)
}
