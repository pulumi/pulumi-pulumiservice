...
func NewPolicy(ctx *pulumi.Context,
	...
	var resource Policy
	err := ctx.RegisterResource("pulumiservice:api/auth:Policy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicy(ctx *pulumi.Context,
	...
	var resource Policy
	err := ctx.ReadResource("pulumiservice:api/auth:Policy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
