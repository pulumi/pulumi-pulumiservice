...
func NewSAML(ctx *pulumi.Context,
	...
	var resource SAML
	err := ctx.RegisterResource("pulumiservice:api/auth:SAML", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSAML(ctx *pulumi.Context,
	...
	var resource SAML
	err := ctx.ReadResource("pulumiservice:api/auth:SAML", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
