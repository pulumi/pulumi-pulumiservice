...
func NewPolicyGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("pulumiservice:api:PolicyGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicyGroup(ctx *pulumi.Context,
	...
	var resource PolicyGroup
	err := ctx.ReadResource("pulumiservice:api:PolicyGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
