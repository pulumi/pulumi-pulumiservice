...
func NewRole(ctx *pulumi.Context,
	...
	var resource Role
	err := ctx.RegisterResource("pulumiservice:api/teams:Role", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRole(ctx *pulumi.Context,
	...
	var resource Role
	err := ctx.ReadResource("pulumiservice:api/teams:Role", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
