...
func NewOrganizationWebhook(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("pulumiservice:api:OrganizationWebhook", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationWebhook(ctx *pulumi.Context,
	...
	var resource OrganizationWebhook
	err := ctx.ReadResource("pulumiservice:api:OrganizationWebhook", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The unique identifier name for the webhook within its scope. Optional on creation; if omitted, the service generates a short random name. Always populated in responses.
func (o OrganizationWebhookOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *OrganizationWebhook) pulumi.StringPtrOutput { return v.Name }).(pulumi.StringPtrOutput)
}
