...
func NewAccessToken(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("pulumiservice:orgs/tokens:AccessToken", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessToken(ctx *pulumi.Context,
	...
	var resource AccessToken
	err := ctx.ReadResource("pulumiservice:orgs/tokens:AccessToken", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
