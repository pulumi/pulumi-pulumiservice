...
func NewOrgAccessToken(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("pulumiservice:orgs/tokens:OrgAccessToken", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrgAccessToken(ctx *pulumi.Context,
	...
	var resource OrgAccessToken
	err := ctx.ReadResource("pulumiservice:orgs/tokens:OrgAccessToken", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o OrgAccessTokenOutput) TokenId() pulumi.StringOutput {
	return o.ApplyT(func(v *OrgAccessToken) pulumi.StringOutput { return v.TokenId }).(pulumi.StringOutput)
}
