...
func NewAgentPool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("pulumiservice:orgs/agents:AgentPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAgentPool(ctx *pulumi.Context,
	...
	var resource AgentPool
	err := ctx.ReadResource("pulumiservice:orgs/agents:AgentPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
