...
func NewEnvironment(ctx *pulumi.Context,
	...
	if args.Yaml != nil {
		args.Yaml = pulumi.ToSecret(args.Yaml).(pulumi.StringInput)
	}
	...
	err := ctx.RegisterResource("pulumiservice:esc:Environment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEnvironment(ctx *pulumi.Context,
	...
	var resource Environment
	err := ctx.ReadResource("pulumiservice:esc:Environment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
