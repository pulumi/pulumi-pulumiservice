...
func NewTag(ctx *pulumi.Context,
	...
	var resource Tag
	err := ctx.RegisterResource("pulumiservice:esc/versions:Tag", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTag(ctx *pulumi.Context,
	...
	var resource Tag
	err := ctx.ReadResource("pulumiservice:esc/versions:Tag", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Environment name.
func (o TagOutput) Environment() pulumi.StringOutput {
	return o.ApplyT(func(v *Tag) pulumi.StringOutput { return v.Environment }).(pulumi.StringOutput)
}

// Organization name.
func (o TagOutput) Organization() pulumi.StringOutput {
	return o.ApplyT(func(v *Tag) pulumi.StringOutput { return v.Organization }).(pulumi.StringOutput)
}
...
// Revision number the tag points to.
func (o TagOutput) Revision() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *Tag) pulumi.IntPtrOutput { return v.Revision }).(pulumi.IntPtrOutput)
}
