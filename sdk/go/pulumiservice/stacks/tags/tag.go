...
func NewTag(ctx *pulumi.Context,
	...
	var resource Tag
	err := ctx.RegisterResource("pulumiservice:stacks/tags:Tag", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTag(ctx *pulumi.Context,
	...
	var resource Tag
	err := ctx.ReadResource("pulumiservice:stacks/tags:Tag", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Stack name.
func (o TagOutput) Stack() pulumi.StringOutput {
	return o.ApplyT(func(v *Tag) pulumi.StringOutput { return v.Stack }).(pulumi.StringOutput)
}

// Tag value.
func (o TagOutput) Value() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Tag) pulumi.StringPtrOutput { return v.Value }).(pulumi.StringPtrOutput)
}
