...
func NewTags(ctx *pulumi.Context,
	...
	var resource Tags
	err := ctx.RegisterResource("pulumiservice:stacks/tags:Tags", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTags(ctx *pulumi.Context,
	...
	var resource Tags
	err := ctx.ReadResource("pulumiservice:stacks/tags:Tags", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Organization name.
func (o TagsOutput) Organization() pulumi.StringOutput {
	return o.ApplyT(func(v *Tags) pulumi.StringOutput { return v.Organization }).(pulumi.StringOutput)
}

// Project name.
func (o TagsOutput) Project() pulumi.StringOutput {
	return o.ApplyT(func(v *Tags) pulumi.StringOutput { return v.Project }).(pulumi.StringOutput)
}

// Stack name.
func (o TagsOutput) Stack() pulumi.StringOutput {
	return o.ApplyT(func(v *Tags) pulumi.StringOutput { return v.Stack }).(pulumi.StringOutput)
}

// Tag name → tag value map managed by this resource.
func (o TagsOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *Tags) pulumi.StringMapOutput { return v.Tags }).(pulumi.StringMapOutput)
}
