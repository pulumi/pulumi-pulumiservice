...
func NewDriftSchedule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("pulumiservice:stacks/deployments:DriftSchedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDriftSchedule(ctx *pulumi.Context,
	...
	var resource DriftSchedule
	err := ctx.ReadResource("pulumiservice:stacks/deployments:DriftSchedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Cron expression for how often drift detection runs.
func (o DriftScheduleOutput) ScheduleCron() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *DriftSchedule) pulumi.StringPtrOutput { return v.ScheduleCron }).(pulumi.StringPtrOutput)
}
