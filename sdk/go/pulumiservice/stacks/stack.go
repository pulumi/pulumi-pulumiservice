...
func NewStack(ctx *pulumi.Context,
	...
	var resource Stack
	err := ctx.RegisterResource("pulumiservice:stacks:Stack", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStack(ctx *pulumi.Context,
	...
	var resource Stack
	err := ctx.ReadResource("pulumiservice:stacks:Stack", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
