...
type Webhook struct {
	...
	Groups WebhookGroupArrayOutput `pulumi:"groups"`
...
// Format of the webhook payload. Can be either `raw`, `slack`, `ms_teams` or `pulumi_deployments`. Defaults to `raw`.
func (o WebhookOutput) Format() WebhookFormatOutput {
	return o.ApplyT(func(v *Webhook) WebhookFormatOutput { return v.Format }).(WebhookFormatOutput)
}

// Optional set of filter groups to apply to the webhook. See [webhook docs](https://www.pulumi.com/docs/intro/pulumi-service/webhooks/#groups) for more information.
func (o WebhookOutput) Groups() WebhookGroupArrayOutput {
	return o.ApplyT(func(v *Webhook) WebhookGroupArrayOutput { return v.Groups }).(WebhookGroupArrayOutput)
}
