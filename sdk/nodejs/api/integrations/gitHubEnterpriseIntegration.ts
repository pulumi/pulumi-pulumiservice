...
export class GitHubEnterpriseIntegration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'pulumiservice:api/integrations:GitHubEnterpriseIntegration';
     ...
     */
    declare public /*out*/ readonly ghUrls: pulumi.Output<outputs.api.integrations.GitHubAppURLs | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly neoGitHubAppPermissionRequirements: pulumi.Output<outputs.api.integrations.GitHubAppPermissionRequirement[] | undefined>;
