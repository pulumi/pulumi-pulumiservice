...
export class AzureDevOpsIntegration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'pulumiservice:api/integrations:AzureDevOpsIntegration';
     ...
     */
    declare public /*out*/ readonly organization: pulumi.Output<outputs.api.integrations.AzureDevOpsOrganization | undefined>;
    /**
     * Metadata about the Azure DevOps project linked to the Pulumi organization
     */
    declare public /*out*/ readonly project: pulumi.Output<outputs.api.integrations.AzureDevOpsProject | undefined>;
    /**
