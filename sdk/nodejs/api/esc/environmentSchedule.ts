...
export class EnvironmentSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'pulumiservice:api/esc:EnvironmentSchedule';
...
export interface EnvironmentScheduleArgs {
     ...
     */
    secretRotationRequest?: pulumi.Input<inputs.api.CreateEnvironmentSecretRotationScheduleRequestArgs | undefined>;
}
