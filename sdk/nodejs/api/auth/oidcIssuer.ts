...
export class OidcIssuer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'pulumiservice:api/auth:OidcIssuer';
     ...
     */
    declare public readonly jwks: pulumi.Output<outputs.api.auth.JSONWebKeySet | undefined>;
    /**
...
export interface OidcIssuerArgs {
     ...
     * The JSON Web Key Set for the OIDC issuer.
     */
    jwks?: pulumi.Input<inputs.api.auth.JSONWebKeySetArgs | undefined>;
    /**
     * The maximum token expiration time in seconds.
     */
