...
export class Policy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'pulumiservice:api/auth:Policy';
     ...
     * List of policies
     */
    declare public readonly policies: pulumi.Output<outputs.api.auth.AuthPolicyDefinition[]>;
    /**
     * The version number
     */
...
export interface PolicyArgs {
     ...
     * List of policies
     */
    policies: pulumi.Input<pulumi.Input<inputs.api.auth.AuthPolicyDefinitionArgs>[]>;
    /**
