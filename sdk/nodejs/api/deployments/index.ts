...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "pulumiservice:api/deployments:ScheduledDeployment":
                return new ScheduledDeployment(name, <any>undefined, { urn })
            case "pulumiservice:api/deployments:Settings":
...
pulumi.runtime.registerResourceModule("pulumiservice", "api/deployments", _module)
