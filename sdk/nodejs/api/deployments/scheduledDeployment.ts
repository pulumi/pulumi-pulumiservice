...
export class ScheduledDeployment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'pulumiservice:api/deployments:ScheduledDeployment';
...
export interface ScheduledDeploymentArgs {
     ...
     */
    request?: pulumi.Input<inputs.api.CreateDeploymentRequestArgs | undefined>;
    /**
