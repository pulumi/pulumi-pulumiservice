...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "pulumiservice:api/insights:Account":
                return new Account(name, <any>undefined, { urn })
            case "pulumiservice:api/insights:ScheduledScanSettings":
...
pulumi.runtime.registerResourceModule("pulumiservice", "api/insights", _module)
