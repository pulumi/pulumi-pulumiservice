...
export class Gate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'pulumiservice:api:Gate';
     ...
     */
    declare public readonly rule: pulumi.Output<outputs.api.ChangeGateApprovalRuleOutput>;
    /**
     * Target configuration for the gate
     */
    declare public readonly target: pulumi.Output<outputs.api.ChangeGateTargetOutput>;
...
export interface GateArgs {
     ...
     * Rule configuration for the gate
     */
    rule: pulumi.Input<inputs.api.ChangeGateApprovalRuleInputArgs>;
    /**
     * Target configuration for the gate
     */
    target: pulumi.Input<inputs.api.ChangeGateTargetInputArgs>;
}
