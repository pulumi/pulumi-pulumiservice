...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "pulumiservice:api/tokens:OrgToken":
                return new OrgToken(name, <any>undefined, { urn })
            case "pulumiservice:api/tokens:PersonalToken":
                return new PersonalToken(name, <any>undefined, { urn })
            case "pulumiservice:api/tokens:TeamToken":
...
pulumi.runtime.registerResourceModule("pulumiservice", "api/tokens", _module)
