...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "pulumiservice:api/stacks:Config":
                return new Config(name, <any>undefined, { urn })
            case "pulumiservice:api/stacks:Stack":
                return new Stack(name, <any>undefined, { urn })
            case "pulumiservice:api/stacks:Tag":
                return new Tag(name, <any>undefined, { urn })
            case "pulumiservice:api/stacks:Webhook":
...
pulumi.runtime.registerResourceModule("pulumiservice", "api/stacks", _module)
