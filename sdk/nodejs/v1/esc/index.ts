...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "pulumiservice:v1/esc:Environment":
                return new Environment(name, <any>undefined, { urn })
            case "pulumiservice:v1/esc:EnvironmentDraft":
                return new EnvironmentDraft(name, <any>undefined, { urn })
            case "pulumiservice:v1/esc:EnvironmentSchedule":
                return new EnvironmentSchedule(name, <any>undefined, { urn })
            case "pulumiservice:v1/esc:EnvironmentSettings":
                return new EnvironmentSettings(name, <any>undefined, { urn })
            case "pulumiservice:v1/esc:EnvironmentTag":
                return new EnvironmentTag(name, <any>undefined, { urn })
            case "pulumiservice:v1/esc:OpenEnvironmentRequest":
                return new OpenEnvironmentRequest(name, <any>undefined, { urn })
            case "pulumiservice:v1/esc:RevisionTag":
                return new RevisionTag(name, <any>undefined, { urn })
            case "pulumiservice:v1/esc:Webhook":
...
pulumi.runtime.registerResourceModule("pulumiservice", "v1/esc", _module)
