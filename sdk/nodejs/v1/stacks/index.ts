...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "pulumiservice:v1/stacks:Config":
                return new Config(name, <any>undefined, { urn })
            case "pulumiservice:v1/stacks:Stack":
                return new Stack(name, <any>undefined, { urn })
            case "pulumiservice:v1/stacks:Tag":
                return new Tag(name, <any>undefined, { urn })
            case "pulumiservice:v1/stacks:Webhook":
...
pulumi.runtime.registerResourceModule("pulumiservice", "v1/stacks", _module)
