...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "pulumiservice:v1/integrations:AzureDevOpsIntegration":
                return new AzureDevOpsIntegration(name, <any>undefined, { urn })
            case "pulumiservice:v1/integrations:BitBucketIntegration":
                return new BitBucketIntegration(name, <any>undefined, { urn })
            case "pulumiservice:v1/integrations:CustomVCSIntegration":
                return new CustomVCSIntegration(name, <any>undefined, { urn })
            case "pulumiservice:v1/integrations:CustomVCSRepository":
                return new CustomVCSRepository(name, <any>undefined, { urn })
            case "pulumiservice:v1/integrations:GitHubEnterpriseIntegration":
                return new GitHubEnterpriseIntegration(name, <any>undefined, { urn })
            case "pulumiservice:v1/integrations:GitHubIntegration":
                return new GitHubIntegration(name, <any>undefined, { urn })
            case "pulumiservice:v1/integrations:GitLabIntegration":
...
pulumi.runtime.registerResourceModule("pulumiservice", "v1/integrations", _module)
