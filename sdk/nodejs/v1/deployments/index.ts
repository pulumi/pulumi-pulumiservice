...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "pulumiservice:v1/deployments:ScheduledDeployment":
                return new ScheduledDeployment(name, <any>undefined, { urn })
            case "pulumiservice:v1/deployments:Settings":
...
pulumi.runtime.registerResourceModule("pulumiservice", "v1/deployments", _module)
