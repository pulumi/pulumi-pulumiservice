...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "pulumiservice:v1/insights:Account":
                return new Account(name, <any>undefined, { urn })
            case "pulumiservice:v1/insights:ScheduledScanSettings":
...
pulumi.runtime.registerResourceModule("pulumiservice", "v1/insights", _module)
