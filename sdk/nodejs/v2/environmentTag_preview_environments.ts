 ...
 */
export class EnvironmentTag_preview_environments extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EnvironmentTag_preview_environments {
        return new EnvironmentTag_preview_environments(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pulumiservice:v2:EnvironmentTag_preview_environments';

    /**
     * Returns true if the given object is an instance of EnvironmentTag_preview_environments.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is EnvironmentTag_preview_environments {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === EnvironmentTag_preview_environments.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: EnvironmentTag_preview_environmentsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(EnvironmentTag_preview_environments.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface EnvironmentTag_preview_environmentsArgs {
    /**
     * The environment name
     */
