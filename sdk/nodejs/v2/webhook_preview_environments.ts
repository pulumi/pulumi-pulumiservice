 ...
 */
export class Webhook_preview_environments extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Webhook_preview_environments {
        return new Webhook_preview_environments(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pulumiservice:v2:Webhook_preview_environments';

    /**
     * Returns true if the given object is an instance of Webhook_preview_environments.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Webhook_preview_environments {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Webhook_preview_environments.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: Webhook_preview_environmentsArgs, opts?: pulumi.CustomResourceOptions) {
 ...
 */
export interface Webhook_preview_environmentsArgs {
    /**
     * Whether the webhook is active and will receive deliveries.
     */
