 ...
 */
export class Webhook_esc_environments extends pulumi.CustomResource {
    /**
     * Get an existing Webhook_esc_environments resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Webhook_esc_environments {
        return new Webhook_esc_environments(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pulumiservice:v2:Webhook_esc_environments';

    /**
     * Returns true if the given object is an instance of Webhook_esc_environments.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Webhook_esc_environments {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Webhook_esc_environments.__pulumiType;
    }
    ...
    /**
     * Create a Webhook_esc_environments resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: Webhook_esc_environmentsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Webhook_esc_environments.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface Webhook_esc_environmentsArgs {
    /**
     * Whether the webhook is active and will receive deliveries.
     */
