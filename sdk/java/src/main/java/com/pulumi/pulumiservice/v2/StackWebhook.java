 ...
 * 
 */
@ResourceType(type="pulumiservice:v2:StackWebhook")
public class StackWebhook extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public StackWebhook(java.lang.String name) {
        this(name, StackWebhookArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public StackWebhook(java.lang.String name, StackWebhookArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public StackWebhook(java.lang.String name, StackWebhookArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:v2:StackWebhook", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private StackWebhook(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:v2:StackWebhook", name, null, makeResourceOptions(options, id), false);
    }

    private static StackWebhookArgs makeArgs(StackWebhookArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? StackWebhookArgs.Empty : args;
    }
     ...
     */
    public static StackWebhook get(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new StackWebhook(name, id, options);
    }
}
