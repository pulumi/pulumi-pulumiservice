 ...
 * 
 */
@ResourceType(type="pulumiservice:v2:StackTag")
public class StackTag extends com.pulumi.resources.CustomResource {
    ...
    public StackTag(java.lang.String name, StackTagArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:v2:StackTag", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private StackTag(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:v2:StackTag", name, null, makeResourceOptions(options, id), false);
    }
