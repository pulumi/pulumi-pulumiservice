 ...
 * 
 */
@ResourceType(type="pulumiservice:v2/agents:Pool")
public class Pool extends com.pulumi.resources.CustomResource {
    ...
    public Pool(java.lang.String name, PoolArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:v2/agents:Pool", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Pool(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:v2/agents:Pool", name, null, makeResourceOptions(options, id), false);
    }
