 ...
 * 
 */
@ResourceType(type="pulumiservice:v2:TeamToken")
public class TeamToken extends com.pulumi.resources.CustomResource {
    ...
    public TeamToken(java.lang.String name, TeamTokenArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:v2:TeamToken", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private TeamToken(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:v2:TeamToken", name, null, makeResourceOptions(options, id), false);
    }
