...
public final class TtlScheduleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param deleteAfterDestroy When true, delete the stack itself (not just resources) after the destroy succeeds.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param timestamp RFC3339 timestamp after which the TTL destroy runs.
         * 
         * @return builder
         * 
         */
