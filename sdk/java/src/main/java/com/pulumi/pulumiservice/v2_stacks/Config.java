 ...
 * 
 */
@ResourceType(type="pulumiservice:v2/stacks:Config")
public class Config extends com.pulumi.resources.CustomResource {
    ...
    public Config(java.lang.String name, ConfigArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:v2/stacks:Config", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Config(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:v2/stacks:Config", name, null, makeResourceOptions(options, id), false);
    }
