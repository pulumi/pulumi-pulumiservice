...
import com.pulumi.pulumiservice.v2_preview.WebhookArgs;
 ...
 * 
 */
@ResourceType(type="pulumiservice:v2/preview:Webhook")
public class Webhook extends com.pulumi.resources.CustomResource {
    ...
    public Webhook(java.lang.String name, WebhookArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:v2/preview:Webhook", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Webhook(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:v2/preview:Webhook", name, null, makeResourceOptions(options, id), false);
    }
