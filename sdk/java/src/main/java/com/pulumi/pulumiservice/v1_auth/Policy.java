 ...
 * 
 */
@ResourceType(type="pulumiservice:v1/auth:Policy")
public class Policy extends com.pulumi.resources.CustomResource {
    ...
    public Policy(java.lang.String name, PolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:v1/auth:Policy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Policy(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:v1/auth:Policy", name, null, makeResourceOptions(options, id), false);
    }
