...
public final class TagArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public TagArgs build() {
            ...
            if ($.orgName == null) {
                throw new MissingRequiredPropertyException("TagArgs", "orgName");
            }
            if ($.projectName == null) {
                throw new MissingRequiredPropertyException("TagArgs", "projectName");
            }
            if ($.stackName == null) {
                throw new MissingRequiredPropertyException("TagArgs", "stackName");
            }
            if ($.value == null) {
