...
public class TemplateSource extends com.pulumi.resources.CustomResource {
     ...
     */
    public TemplateSource(java.lang.String name) {
     ...
     */
    public TemplateSource(java.lang.String name, TemplateSourceArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public TemplateSource(java.lang.String name, TemplateSourceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:index:TemplateSource", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private TemplateSource(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:index:TemplateSource", name, null, makeResourceOptions(options, id), false);
    }

    private static TemplateSourceArgs makeArgs(TemplateSourceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? TemplateSourceArgs.Empty : args;
    }
     ...
     */
    public static TemplateSource get(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
