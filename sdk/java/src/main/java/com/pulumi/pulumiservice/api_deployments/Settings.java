...
import com.pulumi.pulumiservice.api_deployments.outputs.CacheOptions;
import com.pulumi.pulumiservice.api_deployments.outputs.DeploymentSettingsGitHub;
import com.pulumi.pulumiservice.api_deployments.outputs.DeploymentSettingsVCSAzureDevOps;
import com.pulumi.pulumiservice.api_deployments.outputs.DeploymentSettingsVCSBitbucket;
import com.pulumi.pulumiservice.api_deployments.outputs.DeploymentSettingsVCSCustom;
import com.pulumi.pulumiservice.api_deployments.outputs.DeploymentSettingsVCSGitHub;
import com.pulumi.pulumiservice.api_deployments.outputs.DeploymentSettingsVCSGitLab;
import com.pulumi.pulumiservice.api_deployments.outputs.ExecutorContext;
import com.pulumi.pulumiservice.api_deployments.outputs.OperationContext;
import com.pulumi.pulumiservice.api_deployments.outputs.SourceContext;
 ...
 * 
 */
@ResourceType(type="pulumiservice:api/deployments:Settings")
public class Settings extends com.pulumi.resources.CustomResource {
    ...
    public Settings(java.lang.String name, SettingsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:api/deployments:Settings", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Settings(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:api/deployments:Settings", name, null, makeResourceOptions(options, id), false);
    }
