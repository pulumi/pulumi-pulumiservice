...
public final class ConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ConfigArgs build() {
            if ($.environment == null) {
                throw new MissingRequiredPropertyException("ConfigArgs", "environment");
            }
            if ($.orgName == null) {
                throw new MissingRequiredPropertyException("ConfigArgs", "orgName");
            }
            if ($.projectName == null) {
                throw new MissingRequiredPropertyException("ConfigArgs", "projectName");
            }
            if ($.stackName == null) {
                throw new MissingRequiredPropertyException("ConfigArgs", "stackName");
            }
            return $;
        }
    }
