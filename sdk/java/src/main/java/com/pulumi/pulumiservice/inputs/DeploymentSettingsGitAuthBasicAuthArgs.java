...
public final class DeploymentSettingsGitAuthBasicAuthArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public DeploymentSettingsGitAuthBasicAuthArgs build() {
            if ($.password == null) {
                throw new MissingRequiredPropertyException("DeploymentSettingsGitAuthBasicAuthArgs", "password");
            }
            if ($.username == null) {
                throw new MissingRequiredPropertyException("DeploymentSettingsGitAuthBasicAuthArgs", "username");
            }
            return $;
        }
    }
