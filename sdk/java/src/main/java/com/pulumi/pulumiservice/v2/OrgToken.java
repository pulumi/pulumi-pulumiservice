 ...
 * 
 */
@ResourceType(type="pulumiservice:v2:OrgToken")
public class OrgToken extends com.pulumi.resources.CustomResource {
    ...
    public OrgToken(java.lang.String name, OrgTokenArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:v2:OrgToken", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private OrgToken(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:v2:OrgToken", name, null, makeResourceOptions(options, id), false);
    }
