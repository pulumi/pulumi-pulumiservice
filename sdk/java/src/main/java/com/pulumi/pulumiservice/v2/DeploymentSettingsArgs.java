...
public final class DeploymentSettingsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public DeploymentSettingsArgs build() {
            if ($.orgName == null) {
                throw new MissingRequiredPropertyException("DeploymentSettingsArgs", "orgName");
            }
            if ($.projectName == null) {
                throw new MissingRequiredPropertyException("DeploymentSettingsArgs", "projectName");
            }
            if ($.stackName == null) {
                throw new MissingRequiredPropertyException("DeploymentSettingsArgs", "stackName");
            }
            return $;
        }
    }
