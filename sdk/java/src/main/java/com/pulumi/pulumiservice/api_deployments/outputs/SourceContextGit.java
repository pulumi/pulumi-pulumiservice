...
public final class SourceContextGit {
    ...
    /**
     * @return (optional) Tag is the git tag name that triggered this deployment. Set by the service when a deployment is queued by a tag push (e.g. `v1.2.3`). Mutually exclusive with `branch`. When set, `commit` will also be set to the SHA the tag points at.
     * 
     */
