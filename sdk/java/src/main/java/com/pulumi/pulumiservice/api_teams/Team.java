...
package com.pulumi.pulumiservice.api_teams;
...
import com.pulumi.pulumiservice.api_teams.outputs.TeamAccountPermission;
import com.pulumi.pulumiservice.api_teams.outputs.TeamEnvironmentSettings;
import com.pulumi.pulumiservice.api_teams.outputs.TeamMemberInfo;
import com.pulumi.pulumiservice.api_teams.outputs.TeamStackPermission;
 ...
 * 
 */
@ResourceType(type="pulumiservice:api/teams:Team")
public class Team extends com.pulumi.resources.CustomResource {
    ...
    public Team(java.lang.String name, TeamArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:api/teams:Team", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Team(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:api/teams:Team", name, null, makeResourceOptions(options, id), false);
    }
