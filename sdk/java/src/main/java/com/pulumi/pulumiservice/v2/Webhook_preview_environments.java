...
import com.pulumi.pulumiservice.v2.Webhook_preview_environmentsArgs;
 ...
 * 
 */
@ResourceType(type="pulumiservice:v2:Webhook_preview_environments")
public class Webhook_preview_environments extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public Webhook_preview_environments(java.lang.String name) {
        this(name, Webhook_preview_environmentsArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public Webhook_preview_environments(java.lang.String name, Webhook_preview_environmentsArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Webhook_preview_environments(java.lang.String name, Webhook_preview_environmentsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:v2:Webhook_preview_environments", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private Webhook_preview_environments(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:v2:Webhook_preview_environments", name, null, makeResourceOptions(options, id), false);
    }

    private static Webhook_preview_environmentsArgs makeArgs(Webhook_preview_environmentsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? Webhook_preview_environmentsArgs.Empty : args;
    }
     ...
     */
    public static Webhook_preview_environments get(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new Webhook_preview_environments(name, id, options);
    }
}
