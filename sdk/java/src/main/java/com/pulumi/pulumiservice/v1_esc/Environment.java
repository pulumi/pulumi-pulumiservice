 ...
 * 
 */
@ResourceType(type="pulumiservice:v1/esc:Environment")
public class Environment extends com.pulumi.resources.CustomResource {
    ...
    public Environment(java.lang.String name, EnvironmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:v1/esc:Environment", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Environment(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:v1/esc:Environment", name, null, makeResourceOptions(options, id), false);
    }
