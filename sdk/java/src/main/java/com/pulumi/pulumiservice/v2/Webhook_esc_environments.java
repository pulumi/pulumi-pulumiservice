...
import com.pulumi.pulumiservice.v2.Webhook_esc_environmentsArgs;
 ...
 * 
 */
@ResourceType(type="pulumiservice:v2:Webhook_esc_environments")
public class Webhook_esc_environments extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public Webhook_esc_environments(java.lang.String name) {
        this(name, Webhook_esc_environmentsArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public Webhook_esc_environments(java.lang.String name, Webhook_esc_environmentsArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Webhook_esc_environments(java.lang.String name, Webhook_esc_environmentsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:v2:Webhook_esc_environments", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private Webhook_esc_environments(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:v2:Webhook_esc_environments", name, null, makeResourceOptions(options, id), false);
    }

    private static Webhook_esc_environmentsArgs makeArgs(Webhook_esc_environmentsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? Webhook_esc_environmentsArgs.Empty : args;
    }
     ...
     */
    public static Webhook_esc_environments get(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new Webhook_esc_environments(name, id, options);
    }
}
