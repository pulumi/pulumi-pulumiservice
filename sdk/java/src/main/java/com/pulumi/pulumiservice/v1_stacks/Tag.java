 ...
 * 
 */
@ResourceType(type="pulumiservice:v1/stacks:Tag")
public class Tag extends com.pulumi.resources.CustomResource {
    ...
    public Tag(java.lang.String name, TagArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:v1/stacks:Tag", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private Tag(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumiservice:v1/stacks:Tag", name, null, makeResourceOptions(options, id), false);
    }
