...
@pulumi.output_type
class StackConfigEnvironment(dict):
    """
    ...
    """
    def __init__(__self__, *,
                 auto: Optional[_builtins.bool] = None,
        ...
        :param _builtins.str version: Optional. Pin an existing environment link to a specific revision. Accepts a numeric revision (e.g. `"3"`) or a revision tag (e.g. `"prod"`). Not valid with `auto`.
        """
        if auto is not None:
    ...
    @_builtins.property
    @pulumi.getter
    def auto(self) -> Optional[_builtins.bool]:
        """
