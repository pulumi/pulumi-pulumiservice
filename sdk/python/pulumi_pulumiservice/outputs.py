...
class StackConfigEnvironment(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool managed: (Preview) When `true`, the Stack manages a dedicated ESC environment (named `<projectName>/<stackName>`) that is created and destroyed alongside the stack.
        """
