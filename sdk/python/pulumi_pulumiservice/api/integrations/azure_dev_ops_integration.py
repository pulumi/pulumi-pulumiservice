...
class AzureDevOpsIntegrationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] integration_id: The Azure DevOps integration identifier
...
@pulumi.type_token("pulumiservice:api/integrations:AzureDevOpsIntegration")
class AzureDevOpsIntegration(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def organization(self) -> pulumi.Output[Optional['_api.outputs.AzureDevOpsOrganization']]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def project(self) -> pulumi.Output[Optional['_api.outputs.AzureDevOpsProject']]:
        """
