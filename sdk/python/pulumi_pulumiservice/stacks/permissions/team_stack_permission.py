...
class TeamStackPermissionArgs:
    def __init__(__self__, *,
                 ...
                 permission: pulumi.Input[_builtins.int],
        ...
        :param pulumi.Input[_builtins.int] permission: Permission level: 0 = no permission, 101 = read, 102 = edit, 103 = admin.
        :param pulumi.Input[_builtins.str] project: Project name.
        :param pulumi.Input[_builtins.str] stack: Stack name.
        :param pulumi.Input[_builtins.str] team: Team name.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def permission(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    @permission.setter
    def permission(self, value: pulumi.Input[_builtins.int]):
...
@pulumi.type_token("pulumiservice:stacks/permissions:TeamStackPermission")
class TeamStackPermission(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 permission: Optional[pulumi.Input[_builtins.int]] = None,
    ...
    def _internal_init(__self__,
        ...
        super(TeamStackPermission, __self__).__init__(
            'pulumiservice:stacks/permissions:TeamStackPermission',
            resource_name,
            __props__,
            opts)
    ...
    @_builtins.property
    @pulumi.getter
    def permission(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Permission level: 0 = no permission, 101 = read, 102 = edit, 103 = admin.
        """
        return pulumi.get(self, "permission")
