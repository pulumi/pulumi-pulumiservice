...
class TagsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Tag name → tag value map managed by this resource.
        """
...
@pulumi.type_token("pulumiservice:stacks/tags:Tags")
class Tags(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a Tags resource with the given unique name, props, and options.
