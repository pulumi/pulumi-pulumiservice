...
class DriftScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] schedule_cron: Cron expression for how often drift detection runs.
        :param pulumi.Input[_builtins.str] stack: Stack name.
        :param pulumi.Input[_builtins.bool] auto_remediate: When true, automatically run an update to reconcile detected drift.
        """
...
@pulumi.type_token("pulumiservice:stacks/deployments:DriftSchedule")
class DriftSchedule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a DriftSchedule resource with the given unique name, props, and options.
    ...
    def _internal_init(__self__,
        ...
        super(DriftSchedule, __self__).__init__(
            'pulumiservice:stacks/deployments:DriftSchedule',
            resource_name,
            __props__,
            opts)
