...
class TtlScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] timestamp: RFC3339 timestamp after which the TTL destroy runs.
        :param pulumi.Input[_builtins.bool] delete_after_destroy: When true, delete the stack itself (not just resources) after the destroy succeeds.
        """
...
@pulumi.type_token("pulumiservice:stacks/deployments:TtlSchedule")
class TtlSchedule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a TtlSchedule resource with the given unique name, props, and options.
    ...
    def _internal_init(__self__,
        ...
        super(TtlSchedule, __self__).__init__(
            'pulumiservice:stacks/deployments:TtlSchedule',
            resource_name,
            __props__,
            opts)
