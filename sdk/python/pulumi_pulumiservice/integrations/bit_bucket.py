...
@pulumi.type_token("pulumiservice:integrations:BitBucket")
class BitBucket(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a BitBucket resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[BitBucketArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a BitBucket resource with the given unique name, props, and options.
    ...
    def _internal_init(__self__,
        ...
        super(BitBucket, __self__).__init__(
            'pulumiservice:integrations:BitBucket',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'BitBucket':
        """
