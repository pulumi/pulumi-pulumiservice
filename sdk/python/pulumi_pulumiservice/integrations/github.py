...
@pulumi.type_token("pulumiservice:integrations:Github")
class Github(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a Github resource with the given unique name, props, and options.
    ...
    def _internal_init(__self__,
        ...
        super(Github, __self__).__init__(
            'pulumiservice:integrations:Github',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'Github':
        """
