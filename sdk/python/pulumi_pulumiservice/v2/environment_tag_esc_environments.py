...
__all__ = ['EnvironmentTag_esc_environmentsArgs', 'EnvironmentTag_esc_environments']

@pulumi.input_type
class EnvironmentTag_esc_environmentsArgs:
...
class EnvironmentTag_esc_environments(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: EnvironmentTag_esc_environmentsArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Adds a new user-defined tag to a Pulumi ESC environment. Tags are key-value pairs that provide contextual metadata for organizing and searching environments (e.g., region=us-east-1, team=platform). The tag name and value are provided in the request body. Returns the created EnvironmentTag on success. Returns 409 if a tag with the same name already exists on the environment.
        ...
        :param str resource_name: The name of the resource.
        :param EnvironmentTag_esc_environmentsArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(EnvironmentTag_esc_environmentsArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = EnvironmentTag_esc_environmentsArgs.__new__(EnvironmentTag_esc_environmentsArgs)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'EnvironmentTag_esc_environments':
        """
