...
class GitHubEnterpriseIntegrationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] integration_id: The GitHub Enterprise integration identifier
...
@pulumi.type_token("pulumiservice:v2/integrations:GitHubEnterpriseIntegration")
class GitHubEnterpriseIntegration(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GitHubEnterpriseIntegrationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = GitHubEnterpriseIntegrationArgs.__new__(GitHubEnterpriseIntegrationArgs)
        ...
        super(GitHubEnterpriseIntegration, __self__).__init__(
            'pulumiservice:v2/integrations:GitHubEnterpriseIntegration',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GitHubEnterpriseIntegration':
        """
