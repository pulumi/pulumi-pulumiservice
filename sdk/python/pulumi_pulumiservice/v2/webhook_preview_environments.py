...
__all__ = ['Webhook_preview_environmentsArgs', 'Webhook_preview_environments']

@pulumi.input_type
class Webhook_preview_environmentsArgs:
...
@pulumi.type_token("pulumiservice:v2:Webhook_preview_environments")
class Webhook_preview_environments(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Webhook_preview_environmentsArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Creates a new webhook for a Pulumi ESC environment. Webhooks allow external services to be notified when environment events occur, such as updates or opens. The request body specifies the webhook configuration including the destination URL, event filters, and format. Returns 400 if the organization name in the request body does not match the URL path parameter. Returns 409 if a webhook with the same name already exists.
        ...
        :param str resource_name: The name of the resource.
        :param Webhook_preview_environmentsArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(Webhook_preview_environmentsArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = Webhook_preview_environmentsArgs.__new__(Webhook_preview_environmentsArgs)
        ...
        super(Webhook_preview_environments, __self__).__init__(
            'pulumiservice:v2:Webhook_preview_environments',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'Webhook_preview_environments':
        """
        ...
        return Webhook_preview_environments(resource_name, opts=opts, __props__=__props__)
