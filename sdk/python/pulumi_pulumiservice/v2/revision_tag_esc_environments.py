...
__all__ = ['RevisionTag_esc_environmentsArgs', 'RevisionTag_esc_environments']

@pulumi.input_type
class RevisionTag_esc_environmentsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] tag_name: The revision tag name
        :param pulumi.Input[_builtins.int] revision: The revision number to associate with the tag.
        """
...
@pulumi.type_token("pulumiservice:v2:RevisionTag_esc_environments")
class RevisionTag_esc_environments(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: RevisionTag_esc_environmentsArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Updates an existing revision tag for a Pulumi ESC environment to point to a different revision number. The tag is identified by its name in the URL path. The request body specifies the new revision number. This allows advancing or rolling back a named reference (e.g., moving the 'prod' tag to a newer or older revision). Returns 204 on success with no response body.
        ...
        :param str resource_name: The name of the resource.
        :param RevisionTag_esc_environmentsArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RevisionTag_esc_environmentsArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RevisionTag_esc_environmentsArgs.__new__(RevisionTag_esc_environmentsArgs)
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["envName", "orgName", "projectName", "tagName"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(RevisionTag_esc_environments, __self__).__init__(
            'pulumiservice:v2:RevisionTag_esc_environments',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'RevisionTag_esc_environments':
        """
        ...
        return RevisionTag_esc_environments(resource_name, opts=opts, __props__=__props__)
