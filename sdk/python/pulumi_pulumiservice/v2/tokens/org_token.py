...
class OrgTokenArgs:
    def __init__(__self__, *,
                 admin: pulumi.Input[_builtins.bool],
    ...
    @_builtins.property
    @pulumi.getter
    def admin(self) -> pulumi.Input[_builtins.bool]:
        """
    ...
    @admin.setter
    def admin(self, value: pulumi.Input[_builtins.bool]):
...
@pulumi.type_token("pulumiservice:v2/tokens:OrgToken")
class OrgToken(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(OrgToken, __self__).__init__(
            'pulumiservice:v2/tokens:OrgToken',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'OrgToken':
        """
