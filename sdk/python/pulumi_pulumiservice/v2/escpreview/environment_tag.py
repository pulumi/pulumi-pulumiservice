...
__all__ = ['EnvironmentTagArgs', 'EnvironmentTag']
...
@pulumi.type_token("pulumiservice:v2/escPreview:EnvironmentTag")
class EnvironmentTag(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param EnvironmentTagArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(EnvironmentTagArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = EnvironmentTagArgs.__new__(EnvironmentTagArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="pulumiservice:v2/preview:EnvironmentTag")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EnvironmentTag, __self__).__init__(
            'pulumiservice:v2/escPreview:EnvironmentTag',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'EnvironmentTag':
        """
