...
@pulumi.type_token("pulumiservice:v2/escPreview:Webhook")
class Webhook(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="pulumiservice:v2/preview:Webhook")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        secret_opts = pulumi.ResourceOptions(additional_secret_outputs=["hasSecret", "secret", "secretCiphertext"])
        opts = pulumi.ResourceOptions.merge(opts, secret_opts)
        super(Webhook, __self__).__init__(
            'pulumiservice:v2/escPreview:Webhook',
            resource_name,
            __props__,
            opts)
