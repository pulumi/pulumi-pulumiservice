...
@pulumi.type_token("pulumiservice:v2/escPreview:RevisionTag")
class RevisionTag(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="pulumiservice:v2/preview:RevisionTag")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RevisionTag, __self__).__init__(
            'pulumiservice:v2/escPreview:RevisionTag',
            resource_name,
            __props__,
            opts)
