...
__all__ = ['Environment_preview_environmentsArgs', 'Environment_preview_environments']

@pulumi.input_type
class Environment_preview_environmentsArgs:
...
@pulumi.type_token("pulumiservice:v2:Environment_preview_environments")
class Environment_preview_environments(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Environment_preview_environmentsArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Creates a new Pulumi ESC (Environments, Secrets, and Configuration) environment within the specified organization. The request body must include the project name and the environment name. Environment names must be unique within a project and may only contain alphanumeric characters, hyphens, underscores, and periods. The newly created environment starts with an empty YAML definition that can be updated via the UpdateEnvironment endpoint.
        ...
        :param str resource_name: The name of the resource.
        :param Environment_preview_environmentsArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(Environment_preview_environmentsArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'Environment_preview_environments':
        """
