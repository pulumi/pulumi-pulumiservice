...
__all__ = ['EnvironmentDraftArgs', 'EnvironmentDraft']
...
@pulumi.type_token("pulumiservice:v1/esc:EnvironmentDraft")
class EnvironmentDraft(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param EnvironmentDraftArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(EnvironmentDraftArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        super(EnvironmentDraft, __self__).__init__(
            'pulumiservice:v1/esc:EnvironmentDraft',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'EnvironmentDraft':
        """
