...
class TeamEnvironmentPermissionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] max_open_duration: The maximum duration for which members of this team may open the environment.
...
@pulumi.type_token("pulumiservice:index:TeamEnvironmentPermission")
class TeamEnvironmentPermission(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="maxOpenDuration")
    def max_open_duration(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The maximum duration for which members of this team may open the environment.
        """
        return pulumi.get(self, "max_open_duration")
