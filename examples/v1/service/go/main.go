...
import (
	services "github.com/pulumi/pulumi-pulumiservice/sdk/go/pulumiservice/v1/services"
...
func main() {
	pulumi.Run(func(ctx *pulumi.Context) error {
		...
		_, err := services.NewService(ctx, "catalogService", &services.ServiceArgs{
			...
			Name:        pulumi.String("v1-service-" + serviceSuffix),
			Description: pulumi.String("An example v1 service catalog entry."),
