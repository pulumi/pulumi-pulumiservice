...
return await Deployment.RunAsync(() =>
{
    ...
    new Ps.V1.Integrations.GitHubIntegration("github", new()
    {
    ...
    new Ps.V1.Integrations.GitHubEnterpriseIntegration("githubEnterprise", new()
    {
        OrgName = organizationName,
    ...
    new Ps.V1.Integrations.GitLabIntegration("gitlab", new()
    {
        OrgName = organizationName,
    ...
    new Ps.V1.Integrations.BitBucketIntegration("bitbucket", new()
    {
        OrgName = organizationName,
    ...
    new Ps.V1.Integrations.AzureDevOpsIntegration("azureDevOps", new()
    {
        OrgName = organizationName,
