...
new ps.v1.integrations.GitHubIntegration("github", {
...
new ps.v1.integrations.GitHubEnterpriseIntegration("githubEnterprise", {
    orgName: organizationName,
...
new ps.v1.integrations.GitLabIntegration("gitlab", {
    orgName: organizationName,
...
new ps.v1.integrations.BitBucketIntegration("bitbucket", {
    orgName: organizationName,
...
new ps.v1.integrations.AzureDevOpsIntegration("azureDevOps", {
    orgName: organizationName,
