...
ps_v1.integrations.GitHubIntegration(
    "github",
...
ps_v1.integrations.GitHubEnterpriseIntegration(
    "githubEnterprise",
    org_name=organization_name,
...
ps_v1.integrations.GitLabIntegration(
    "gitlab",
    org_name=organization_name,
...
ps_v1.integrations.BitBucketIntegration(
    "bitbucket",
    org_name=organization_name,
...
ps_v1.integrations.AzureDevOpsIntegration(
    "azureDevOps",
    org_name=organization_name,
