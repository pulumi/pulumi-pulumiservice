...
new ps.v1.DefaultOrganization("defaultOrg", { orgName: organizationName });

// 2. OIDC issuers: GitHub Actions trust + Pulumi Cloud self-trust.
new ps.v1.auth.OidcIssuer("githubIssuer", {
...
new ps.v1.auth.OidcIssuer("pulumiSelfIssuer", {
    orgName: organizationName,
...
const ciToken = new ps.v1.tokens.OrgToken("ciToken", {
    orgName: organizationName,
    name: `ci-${suffix}`,
...
new ps.v1.tokens.TeamToken("teamToken", {
    orgName: organizationName,
...
const runnersPool = new ps.v1.agents.Pool("runnersPool", {
    orgName: organizationName,
...
const sharedCredentials = new ps.v1.esc.Environment("sharedCredentials", {
    orgName: organizationName,
    project: "shared",
    name: `credentials-${suffix}`,
});
new ps.v1.esc.EnvironmentTag("stableTag", {
    orgName: organizationName,
...
const stagingStack = new ps.v1.stacks.Stack("stagingStack", {
    orgName: organizationName,
    projectName: `platform-app-${suffix}`,
    stackName: "staging",
});
const prodStack = new ps.v1.stacks.Stack("prodStack", {
    orgName: organizationName,
    projectName: `platform-app-${suffix}`,
    stackName: "prod",
});
...
for (const [k, v] of Object.entries({
    ...
    new ps.v1.stacks.Tag(`prodTag-${k}`, {
        orgName: organizationName,
        projectName: prodStack.projectName,
        stackName: prodStack.stackName,
        name: k,
...
new ps.v1.stacks.Webhook("prodPagerDuty", {
...
new ps.v1.deployments.Settings("stagingDeploySettings", {
    orgName: organizationName,
    projectName: stagingStack.projectName,
    stackName: stagingStack.stackName,
    executorContext: { executorImage: { reference: "pulumi/pulumi:latest" } },
});
const prodDeploySettings = new ps.v1.deployments.Settings("prodDeploySettings", {
    orgName: organizationName,
    projectName: prodStack.projectName,
    stackName: prodStack.stackName,
...
new ps.v1.Gate("credsApprovalGate", {
    orgName: organizationName,
...
new ps.v1.deployments.ScheduledDeployment("prodNightlyDeploy", {
    orgName: organizationName,
    projectName: prodStack.projectName,
    stackName: prodStack.stackName,
    scheduleCron: "0 7 * * *",
...
new ps.v1.OrganizationWebhook("slack", {
    organizationName: organizationName,
...
new ps.v1.PolicyGroup("starterPolicyGroup", {
    orgName: organizationName,
...
new ps.v1.teams.Role("platformTeamRole", {
    orgName: organizationName,
    teamName: platformTeam.name,
