...
return await Deployment.RunAsync(() =>
{
    ...
    new Ps.V1.DefaultOrganization("defaultOrg", new() { OrgName = organizationName });

    new Ps.V1.Auth.OidcIssuer("githubIssuer", new()
    {
    ...
    new Ps.V1.Auth.OidcIssuer("pulumiSelfIssuer", new()
    {
        OrgName = organizationName,
    ...
    var platformTeam = new Ps.V1.Teams.Team("platformTeam", new()
    {
        OrgName = organizationName,
    ...
    new Ps.V1.Role("stackReadonlyRole", new()
    {
        OrgName = organizationName,
    ...
    var ciToken = new Ps.V1.Tokens.OrgToken("ciToken", new()
    {
        OrgName = organizationName,
        Name = $"ci-{suffix}",
    ...
    new Ps.V1.Tokens.TeamToken("teamToken", new()
    {
        OrgName = organizationName,
    ...
    var runnersPool = new Ps.V1.Agents.Pool("runnersPool", new()
    {
        OrgName = organizationName,
    ...
    var templates = new Ps.V1.OrgTemplateCollection("templates", new()
    {
        OrgName = organizationName,
    ...
    var sharedCredentials = new Ps.V1.Esc.Environment("sharedCredentials", new()
    {
        OrgName = organizationName,
        Project = "shared",
        Name = $"credentials-{suffix}",
    });
    new Ps.V1.Esc.EnvironmentTag("stableTag", new()
    {
        OrgName = organizationName,
    ...
    var stagingStack = new Ps.V1.Stacks.Stack("stagingStack", new()
    {
        OrgName = organizationName,
        ProjectName = $"platform-app-{suffix}",
        StackName = "staging",
    });
    var prodStack = new Ps.V1.Stacks.Stack("prodStack", new()
    {
        OrgName = organizationName,
        ProjectName = $"platform-app-{suffix}",
        StackName = "prod",
    ...
    new Ps.V1.Stacks.Config("stagingConfig", new()
    {
        OrgName = organizationName,
    ...
    new Ps.V1.Stacks.Config("prodConfig", new()
    {
        OrgName = organizationName,
    ...
    {
        new Ps.V1.Stacks.Tag($"prodTag-{k}", new()
        {
            OrgName = organizationName,
            ProjectName = prodStack.ProjectName,
            StackName = prodStack.StackName,
    ...
    new Ps.V1.Stacks.Webhook("prodPagerDuty", new()
    {
    ...
    new Ps.V1.Deployments.Settings("stagingDeploySettings", new()
    {
        OrgName = organizationName,
        ProjectName = stagingStack.ProjectName,
        StackName = stagingStack.StackName,
    ...
    var prodDeploySettings = new Ps.V1.Deployments.Settings("prodDeploySettings", new()
    {
        OrgName = organizationName,
        ProjectName = prodStack.ProjectName,
        StackName = prodStack.StackName,
    ...
    new Ps.V1.Gate("credsApprovalGate", new()
    {
        OrgName = organizationName,
    ...
    new Ps.V1.Deployments.ScheduledDeployment("prodNightlyDeploy", new()
    {
        OrgName = organizationName,
        ProjectName = prodStack.ProjectName,
        StackName = prodStack.StackName,
    ...
    new Ps.V1.OrganizationWebhook("slack", new()
    {
        OrganizationName = organizationName,
    ...
    new Ps.V1.PolicyGroup("starterPolicyGroup", new()
    {
        OrgName = organizationName,
