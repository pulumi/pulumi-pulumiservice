...
new ps.api.integrations.GitHubIntegration("github", {
...
new ps.api.integrations.GitHubEnterpriseIntegration("githubEnterprise", {
    orgName: organizationName,
...
new ps.api.integrations.GitLabIntegration("gitlab", {
    orgName: organizationName,
...
new ps.api.integrations.BitBucketIntegration("bitbucket", {
    orgName: organizationName,
...
new ps.api.integrations.AzureDevOpsIntegration("azureDevOps", {
    orgName: organizationName,
