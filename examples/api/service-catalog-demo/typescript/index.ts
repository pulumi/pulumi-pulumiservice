...
// === Owner team (re-impl of api Team in api namespace) ===
const ownerTeam = new ps.api.teams.Team("ownerTeam", {
...
const stacks = {
    checkout: new ps.api.stacks.Stack("checkoutStack", {
        orgName: organizationName,
        projectName,
        stackName: "checkout-prod",
    }),
    search: new ps.api.stacks.Stack("searchStack", {
        orgName: organizationName,
        projectName,
        stackName: "search-prod",
    }),
    notification: new ps.api.stacks.Stack("notificationStack", {
        orgName: organizationName,
        projectName,
...
new ps.api.services.Service("checkoutService", {
    orgName: organizationName,
...
new ps.api.services.Service("searchService", {
    orgName: organizationName,
...
new ps.api.services.Service("notificationService", {
    orgName: organizationName,
...
const webhook = new ps.api.OrganizationWebhook("webhook", {
...
const env = new ps.api.esc.Environment("bootstrapEnv", {
    orgName: organizationName,
    project: envProject,
    name: envName,
    yaml: [
...
const envSchedule = new ps.api.esc.EnvironmentSchedule("envSchedule", {
    orgName: organizationName,
...
// const customRole = new ps.api.Role("customRole", {
//     orgName: organizationName,
//     roleID: customRoleID,
// }, { import: `${organizationName}/${customRoleID}` });

// new ps.api.teams.Role("customRoleAssignment", {
//     orgName: organizationName,
