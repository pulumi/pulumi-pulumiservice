...
import com.pulumi.pulumiservice.api_stacks.Config;
import com.pulumi.pulumiservice.api_stacks.ConfigArgs;
import com.pulumi.pulumiservice.api_stacks.Webhook;
import com.pulumi.pulumiservice.api_stacks.WebhookArgs;
...
public class App {
    public static void main(String[] args) {
        Pulumi.run(ctx -> {
            ...
            var projectName = config.get("projectName").orElse("api-stack-config-example");
