...
func main() {
	pulumi.Run(func(ctx *pulumi.Context) error {
		...
		orgAll, err := api.NewOrganizationWebhook(ctx, "orgWebhookAll", &api.OrganizationWebhookArgs{
		...
		orgGroups, err := api.NewOrganizationWebhook(ctx, "orgWebhookGroups", &api.OrganizationWebhookArgs{
			OrganizationName: pulumi.String(organizationName),
