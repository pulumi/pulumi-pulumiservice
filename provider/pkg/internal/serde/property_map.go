...
func ToPropertyMap(obj any, structTagName string) resource.PropertyMap {
...
func GetOldsAndNews(req *pulumirpc.DiffRequest) (resource.PropertyMap, resource.PropertyMap, error) {
