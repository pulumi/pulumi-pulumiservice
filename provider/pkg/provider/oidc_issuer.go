...
func GenerateOidcIssuerProperties(input PulumiServiceOidcIssuerInput, issuer *pulumiapi.OidcIssuerRegistrationResponse, authPolicy *pulumiapi.AuthPolicy) (outputs *structpb.Struct, inputs *structpb.Struct, err error) {
	...
	inputs, err = plugin.MarshalProperties(inputMap, StandardMarshal)
	if err != nil {
		return nil, nil, err
	}

	outputs, err = plugin.MarshalProperties(outputMap, StandardMarshal)
	if err != nil {
		return nil, nil, err
	}
...
func (oir *PulumiServiceOidcIssuerResource) Diff(req *pulumirpc.DiffRequest) (*pulumirpc.DiffResponse, error) {
	...
	return StandardDiff(req, replaceProperties)
}
...
func (oir *PulumiServiceOidcIssuerResource) Create(req *pulumirpc.CreateRequest) (*pulumirpc.CreateResponse, error) {
	ctx := context.Background()
	inputMap, err := plugin.UnmarshalProperties(req.GetProperties(), StandardUnmarshal)
	if err != nil {
		return nil, err
	}
...
func (oir *PulumiServiceOidcIssuerResource) Check(req *pulumirpc.CheckRequest) (*pulumirpc.CheckResponse, error) {
	...
	inputMap, err := plugin.UnmarshalProperties(req.GetNews(), StandardUnmarshal)
	if err != nil {
		return nil, err
	}
	input := oir.ToPulumiServiceOidcIssuerInput(inputMap)
	inputs, err := plugin.MarshalProperties(input.toPropertyMap(), StandardMarshal)
	if err != nil {
		return nil, err
	}
...
func (oir *PulumiServiceOidcIssuerResource) Configure(_ PulumiServiceConfig) {
}
