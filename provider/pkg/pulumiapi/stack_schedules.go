...
type StackScheduleClient interface {
	CreateDeploymentSchedule(
		ctx context.Context, stack StackIdentifier, req CreateDeploymentScheduleRequest,
	) (*string, error)
	...
	UpdateDeploymentSchedule(
		ctx context.Context, stack StackIdentifier, req CreateDeploymentScheduleRequest, scheduleID string,
	) (*string, error)
	UpdateDriftSchedule(
		ctx context.Context, stack StackIdentifier, req CreateDriftScheduleRequest, scheduleID string,
	) (*string, error)
	UpdateTtlSchedule(
		ctx context.Context, stack StackIdentifier, req CreateTtlScheduleRequest, scheduleID string,
	) (*string, error)
...
func (c *Client) CreateDeploymentSchedule(
	ctx context.Context, stack StackIdentifier, scheduleReq CreateDeploymentScheduleRequest,
) (*string, error) {
...
func (c *Client) CreateDriftSchedule(
	ctx context.Context, stack StackIdentifier, scheduleReq CreateDriftScheduleRequest,
) (*string, error) {
	apiPath := path.Join(
		"stacks", stack.OrgName, stack.ProjectName, stack.StackName, "deployments", "drift", "schedules",
	)
	var scheduleResponse StackScheduleResponse
	_, err := c.do(ctx, http.MethodPost, apiPath, scheduleReq, &scheduleResponse)
	if err != nil {
...
func (c *Client) CreateTtlSchedule(
	ctx context.Context, stack StackIdentifier, scheduleReq CreateTtlScheduleRequest,
) (*string, error) {
...
func (c *Client) GetStackSchedule(
	ctx context.Context, stack StackIdentifier, scheduleID string,
) (*StackScheduleResponse, error) {
	apiPath := path.Join(
		"stacks", stack.OrgName, stack.ProjectName, stack.StackName, "deployments", "schedules", scheduleID,
	)
	var scheduleResponse StackScheduleResponse
...
func (c *Client) UpdateDeploymentSchedule(
	ctx context.Context, stack StackIdentifier, scheduleReq CreateDeploymentScheduleRequest, scheduleID string,
) (*string, error) {
	apiPath := path.Join(
		"stacks", stack.OrgName, stack.ProjectName, stack.StackName, "deployments", "schedules", scheduleID,
	)
...
func (c *Client) UpdateDriftSchedule(
	ctx context.Context, stack StackIdentifier, scheduleReq CreateDriftScheduleRequest, scheduleID string,
) (*string, error) {
	apiPath := path.Join(
		"stacks", stack.OrgName, stack.ProjectName, stack.StackName, "deployments", "drift", "schedules", scheduleID,
	)
	var scheduleResponse StackScheduleResponse
	_, err := c.do(ctx, http.MethodPost, apiPath, scheduleReq, &scheduleResponse)
	if err != nil {
...
func (c *Client) UpdateTtlSchedule(
	ctx context.Context, stack StackIdentifier, scheduleReq CreateTtlScheduleRequest, scheduleID string,
) (*string, error) {
	apiPath := path.Join(
		"stacks", stack.OrgName, stack.ProjectName, stack.StackName, "deployments", "ttl", "schedules", scheduleID,
	)
	var scheduleResponse StackScheduleResponse
	_, err := c.do(ctx, http.MethodPost, apiPath, scheduleReq, &scheduleResponse)
	if err != nil {
