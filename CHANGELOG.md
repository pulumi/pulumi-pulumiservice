...
- Fixed Environment resource being spuriously replaced when upgrading from pre-0.25.0 provider versions due to the `project` field (added in v0.25.0) appearing as a new replace property in the diff
