...
- Added `role` property to DeploymentSettings `operationContext` for configuring deployment roles
...
- Fixed DeploymentSettings Check failing on unknown inputs during preview
